function [rotation_error_manopt,translation_error_manopt, ...
    exectime_manopt] = ...
    do_som_manopt_maxiter(testdata, sigma, mu, params)
%DO_SOM_MANOPT_MAXITER Function that executes the Shape of Motion 
...
%the precision, accuracy and exectime when increasing the maximum potential
