function rotDyn_controlPD_test_movingReference
resetRands();
...
optsControl={'inertiaMatrix',J,'flagCancelDynamics',true,'gainRotationError',15,'gainVelocityError',5};
...
plot(t,rot_logVec(R))
hold on
plot(t,rot_logVec(RReference(t)),':')
hold off
