function [x0, xd, xd_dd, LfB, LgB, Bf, h_i, x_i, y_i, r_i, axisBound] = obs_delayedTraj(m)
...
timeDelay = 12;
xd = @(t) [10*sin(max(0,t-timeDelay)); 10*cos(max(0,t-timeDelay))-10;...
    10*cos(max(0,t-timeDelay))-10*(t<timeDelay);...
    -10*sin(max(0,t-timeDelay))]; % Delayed Trajectory
xd_dd = @(t) [-10*sin(max(0,t-timeDelay));...
    -10*cos(max(0,t-timeDelay))+10*(t<timeDelay)];
% Set the boundary for the display
axisBound = [-25 40 -25 40];
end
