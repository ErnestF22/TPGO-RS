function [ Ft, dFt, appder ] = rotBundle_metric_sasaki_CompatibilityTest( R, dR, U, X, Y )
...
%   dR(R) := The vector field induced by R(t) as a function handle of
%       paramter R
...
% Useful parameters
Z = @(t) [R(t);U(R(t))];
Z_dot_lower = rot_covar(dR, U); % This is a function of R
Z_dot = @(R,U) [dR(R); Z_dot_lower(R)];
...
% Right Terms
d_Z_dot_X = rotBundle_covar_sasaki(Z_dot, X, U); % This is a function of (R,U)
d_Z_dot_Y = rotBundle_covar_sasaki(Z_dot, Y, U); % This is a function of (R,U)
