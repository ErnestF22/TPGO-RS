...
% Define Left Invarient Vector Fields on TSO(3) that depends on RRef
x1 = randn(3,1); x2 = randn(3,1);
X = @(R,U,RRef) [U;R*hat3(x1)+R*RRef'*RRef*hat3(RRef*x2)];
...
dX_dt = funApproxDer(@(t) X(R0,UR0,RRef(t)),t);
