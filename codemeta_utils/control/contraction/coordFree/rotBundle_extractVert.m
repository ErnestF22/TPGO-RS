function [ Xv ] = rotBundle_extractVert( Z, X )
% Given a tangent vector in T_{p}T_{u}SO(3), extract the vertical
% component given by Xv = RkDiff(X);
% INPUTS:
