function [A_all_func] = rotRefOpt_allBounds_Matrix()
...
% handles  of (R,w,RRef,gains,M_nn,b)
% NOTE: To do this we relaxed abs(a+bi) <= abs(a) + abs(b)
% INPUTS:
% OUTPUTS:
%   A_all_func(R,w,RRef,gains,M_nn,b) := a cell array of all possible 
...
A2_mat = {A_22};
A_33(1,1) = m4*b-kref*m4*mag_RRef/2*cot(mag_RRef/2);
A_33 = (A_33 + A_33')/2;
A3_mat = {A_33};
...
temp_func = matlabFunction(tempBounds,'Vars',[mag_R,mag_RRef,kd,kv,kref,mag_W,m1,m2,m3,m4,m5,m6,b]);
