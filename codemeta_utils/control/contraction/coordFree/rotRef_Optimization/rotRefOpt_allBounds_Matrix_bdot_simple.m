function [A_all_func_bdot] = rotRefOpt_allBounds_Matrix_bdot_simple()
...
% (R,w,RRef,gains,M_nn,beta_dot)
% NOTE: To do this we relaxed abs(a+bi) <= abs(a) + abs(b)
% INPUTS:
% OUTPUTS:
%   A_all_func_bdot(R,w,RRef,gains,M_nn,beta_dot) := a matrix handle of all possible 
...
% 
% Fill entries
tempMat1 = m2*sqrt(3)*b_dot;
tempMat2 = m2*sqrt(3)*b_dot;
tempMat3 = - m2*sqrt(3)*b_dot;
