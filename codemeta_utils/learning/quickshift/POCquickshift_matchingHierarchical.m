function POCquickshift_matchingHierarchical
resetRands()
NPointsCluster=20;
[X,membershipPrior,NPoints]=quickshift_test_datasets('correspondences',...
    'NPointsCluster',NPointsCluster,'NClusters',5);


paramsMatching={'gaussian',...
    'ratioDensity',0.25,...
    ...
    for iBatch=1:NBatches
        ...
        if NClasses==1
            ...
            [labelsMatch,info]=quickshift_matching(DBatch,membershipPriorBatch,...
                paramsMatching{:},optsMatchingScales{:},'getcomponentdistances');
