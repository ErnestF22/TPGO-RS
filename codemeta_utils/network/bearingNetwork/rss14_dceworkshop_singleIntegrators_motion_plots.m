function rss14_dceworkshop_singleIntegrators_motion_plots
close all
figDir='~/Documents/Dropbox/2014-RSSDCEWorkshop/figures';
figDim=1*[300,150];
figDimSmall=[300,100];
...
for iCostBearings=1:NCostBearings
    ...
    for flagUseRanges=[false true]
        baseFileName=['rss14_dceworkshop_singleIntegrators_motion_' costNameBearings '_'];
        if ~flagUseRanges
