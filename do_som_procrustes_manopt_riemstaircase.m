function [rotation_error_manopt,translation_error_manopt, ...
    ...
    rotation_error_manopt_rc,translation_error_manopt_rc, ...
    exectime_manopt,exectime_procrustes,exectime_manopt_rc] = ...
        do_som_procrustes_manopt_riemstaircase(testdata, sigma, mu, params)
...
transf_manopt_rc = som_riemannian_staircase(T_globalframe_nois, Tijs_vec_nois, edges, params, G2R(transf_initguess), G2T(transf_initguess));
% manopt_rc_end_time = tic();
exectime_manopt_rc = toc(manopt_rc_start_time);
...
[rotation_error_manopt_rc,translation_error_manopt_rc] = testNetworkComputeErrors(testdata);
