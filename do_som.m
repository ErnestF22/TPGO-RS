function [rotation_error_manopt,translation_error_manopt, ...
    ...
    exectime_manopt,exectime_procrustes] = do_som(testdata, sigma, mu, params)
%DO_SOM Function that executes the Shape of Motion algorithms through
%Manopt and Procrustes pipelines, returning rotation and translation
