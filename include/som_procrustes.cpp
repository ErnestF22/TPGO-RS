...
SomProcrustes::SomProcrustes() {}

SomProcrustes::SomProcrustes(SomUtils::SomSize somSz, SomUtils::MatD &Tijs, Eigen::MatrixXi &edges)
{
    sz_ = somSz;
    Tijs_ = Tijs;
    edges_ = edges;
...
SomProcrustes::SomProcrustes(const SomUtils::SomSize somSz, const SomUtils::MatD &Tijs, const Eigen::MatrixXi &edges)
{
    sz_ = somSz;
    Tijs_ = Tijs;
    edges_ = edges;
...
void SomProcrustes::getMiFromMmat(const SomUtils::MatD &Mmat, SomUtils::MatD &Mi, int idx) const
{
...
void SomProcrustes::stepOne(const SomUtils::MatD &T)
{
...
void SomProcrustes::stepTwo(const SomUtils::VecMatD &R)
{
...
void SomProcrustes::makeMN(const SomUtils::MatD &T, SomUtils::MatD &Mmat, SomUtils::MatD &Nmat) const
{
...
void SomProcrustes::makeAb(const SomUtils::VecMatD &Rgf, SomUtils::MatD &A, SomUtils::MatD &b) const
{
...
void SomProcrustes::setRgt(const SomUtils::VecMatD &Rgt)
{
    Rgt_ = Rgt;
}

void SomProcrustes::setTgt(const SomUtils::MatD &Tgt)
{
    Tgt_ = Tgt;
}

SomUtils::MatD SomProcrustes::getTout() const
{
    return Tout_;
}

SomUtils::VecMatD SomProcrustes::getRout() const
{
    return Rout_;
}

void SomProcrustes::vectorizeRT(const SomUtils::VecMatD &R, const SomUtils::MatD &T, SomUtils::MatD &XvecOut) const
{
...
double SomProcrustes::norm(const SomUtils::VecMatD &R1, const SomUtils::MatD &T1, const SomUtils::VecMatD &R2, const SomUtils::MatD &T2) const
{
...
double SomProcrustes::norm(const SomUtils::VecMatD &R, const SomUtils::MatD &T) const
{
...
void SomProcrustes::setTcurr(const SomUtils::MatD &Tcurr)
{
    Tcurr_ = Tcurr;
}
