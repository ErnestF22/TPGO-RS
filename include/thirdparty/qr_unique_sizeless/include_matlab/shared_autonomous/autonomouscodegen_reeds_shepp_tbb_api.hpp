 ...
 * (TBB-acelerated) To fully support code generation, note that this file needs
 * to be fully compliant with the C89/C90 (ANSI) standard.
 */
 ...
 */
EXTERN_C AUTONOMOUS_CODEGEN_API void
autonomousReedsSheppDistanceCodegen_tbb_real64(const real64_T *startPose,
