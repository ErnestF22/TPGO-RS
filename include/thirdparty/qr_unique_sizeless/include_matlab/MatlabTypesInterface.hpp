...
public:
  ...
  /// Returns a converted copy of the array which contains complex numbers
  /// instead of reals
  ...
  template <typename T> result_type operator()(const T &arr)
  {
...
/**
 *  @brief Converts matlab::data::Array data to std::vector for most simple
 * types
 ...
 *  @exception - Exceptions can occur when calling into MATLAB. Check Doc for
 * C++ Shared Library or C++ Engine API.
 */
template <typename T>
...
convertMDAtoVector(matlab::data::Array strArray)
{
  size_t numel = strArray.getNumberOfElements();
  std::vector<std::u16string> strVector(numel);
  matlab::data::TypedArray<matlab::data::MATLABString> tempStringArray(
      strArray);
  ...
  for (size_t k = 0; k < numel; k++) {
    ...
    if (tempString.has_value()) {
      strVector.at(k) =
          *tempString; // Access is done this way to support "MATLABString =
                       // optional<String> = std::basic_string<char16_t>"
    } else {
      strVector.at(k) = u"";
    }
  }
...
template <typename T> inline T convertMDAtoScalar(matlab::data::Array arr)
{
  // Convert the MDA to a TypedArray
  matlab::data::TypedArray<T> arrTyped = arr;
  T value = arr[0];
...
/// Template specialization - Converts an MDA containing a string to a string.
/// Used for char array as well.
template <> inline std::u16string convertMDAtoScalar(matlab::data::Array arr)
{
  if (arr.getType() == matlab::data::ArrayType::CHAR) {
    ...
    if (str.has_value()) {
      return *str; // Access is done this way to support "MATLABString =
                   // optional<String> = std::basic_string<char16_t>"
    } else {
      return u"";
    }
...
template <typename ControllerType> class MATLABObject {
public:
  ...
  MATLABObject(std::shared_ptr<ControllerType> matlabPtr,
               std::u16string clsName)
  ...
  MATLABObject(std::shared_ptr<ControllerType> matlabPtr,
      ...
      : m_matlabPtr(matlabPtr), m_object(obj)
  {
  }
...
protected:
  ...
  /**
   *  @brief Gets the specified non-complex scalar MATLAB property belonging to
   * this object
   *  @param propName - The name of the property in MATLAB
   *  @return The returned value of the scalar property
   *  @exception InvalidArrayTypeException if type is not supported by
   * TypedArray
   *  @exception - Exceptions can occur when calling into MATLAB. Check Doc for
   * C++ Shared Library or C++ Engine API.
   */
  ...
  /**
   *  @brief Gets the specified scalar MATLAB property belonging to this object.
   * Handles gets that might return as complex.
   *  @param propName - The name of the property in MATLAB
   ...
   *  @exception - InvalidArrayTypeException if type is not supported by create
   * scalar
   *  @exception - Exceptions can occur when calling into MATLAB. Check Doc for
   * C++ Shared Library or C++ Engine API.
   */
  ...
  /**
   *  @brief Gets the specified 1-D array MATLAB property belonging to this
   * object
   *  @param propName - The name of the property in MATLAB
   *  @return the returned vector containing the property data
   *  @exception InvalidArrayTypeException if type is not supported by
  ...
  /**
   *  @brief Sets the specified 1-D array MATLAB property belonging to this
   * object
   *  @param propName - The name of the property in MATLAB
   ...
   */
  template <typename T>
  inline void MATLABSetVectorProperty(std::u16string propName,
                                      std::vector<T> value)
  {
    matlab::data::ArrayFactory arrayFactory;
    MATLABSetArrayProperty(
        propName,
   ...
   * C++ Shared Library or C++ Engine API.
   */
  inline void MATLABSetArrayProperty(std::u16string propName,
  ...
  /**
   *  @brief Used for calling a method of this MATLAB object which has no
   * outputs
  ...
  /**
   *  @brief Used for calling a method of this MATLAB object which has one
   * output
   *  @param fcn - The method of this MATLAB object to call using feval
   *  @param args - The arguments to the method
   *  @return The 1 returned value that should result from calling the method in
   * MATLAB
   *  @exception - Exceptions can occur when calling into MATLAB. Check Doc for
   * C++ Shared Library or C++ Engine API.
   */
  inline matlab::data::Array
  MATLABCallOneOutputMethod(std::u16string fcn,
                            std::vector<matlab::data::Array> args)
  {
  ...
  /**
   *  @brief Used for calling a method of this MATLAB object which has more than
   * 1 output
   *  @param fcn - The method of this MATLAB object to call using feval
   *  @param args - The arguments to the method
   *  @return The returned values that should result from calling the method in
   * MATLAB
   *  @exception - Exceptions can occur when calling into MATLAB. Check Doc for
   * C++ Shared Library or C++ Engine API.
   */
  inline std::vector<matlab::data::Array>
  MATLABCallMultiOutputMethod(std::u16string fcn, size_t nOut,
                              std::vector<matlab::data::Array> args)
  {
...
private:
  /**
   *  @brief Initializes the underlying MATLAB object by creating it in MATLAB
   ...
   */
  inline matlab::data::Array
  MATLABCallDefaultConstructor(std::u16string clsName)
  {
    std::vector<matlab::data::Array> args;
...
// Class for handle object support
template <typename ControllerType>
class MATLABHandleObject : public MATLABObject<ControllerType> {
public:
  MATLABHandleObject() : MATLABObject<ControllerType>()
  {
  }

  MATLABHandleObject(std::shared_ptr<ControllerType> matlabPtr,
                     std::u16string clsName)
      : MATLABObject<ControllerType>(matlabPtr, clsName)
  {
  }

  MATLABHandleObject(std::shared_ptr<ControllerType> matlabPtr,
                     matlab::data::Array obj)
      : MATLABObject<ControllerType>(matlabPtr, obj)
  {
  }

  bool isvalid()
  {
    std::vector<matlab::data::Array> _args = {this->m_object};
    matlab::data::TypedArray<bool> _result_mda =
        this->m_matlabPtr->feval(u"isvalid", _args);
...
template <>
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetScalarProperty(
    std::u16string propName, char16_t value)
{
  matlab::data::ArrayFactory arrayFactory;
  std::u16string str(1, value);
  MATLABObject<MATLABControllerType>::MATLABSetArrayProperty(
      propName, arrayFactory.createCharArray(str));
}
...
MATLABObject<MATLABControllerType>::MATLABGetScalarProperty(
    std::u16string propName)
{
...
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetScalarProperty(
    std::u16string propName, std::u16string value)
{
  matlab::data::ArrayFactory arrayFactory;
  MATLABObject<MATLABControllerType>::MATLABSetArrayProperty(
      propName, arrayFactory.createCharArray(value));
}
...
template <>
inline std::vector<std::u16string>
MATLABObject<MATLABControllerType>::MATLABGetVectorProperty(
    std::u16string propName)
{
...
inline void MATLABObject<MATLABControllerType>::MATLABSetVectorProperty(
    std::u16string propName, std::vector<std::u16string> value)
{
  matlab::data::ArrayFactory arrayFactory;
...
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetVectorProperty(
    std::u16string propName, std::vector<matlab::data::Object> value)
{
  matlab::data::ArrayFactory arrayFactory;
  size_t numel = value.size();
...
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetScalarProperty(
    std::u16string propName, matlab::data::Array value)
{
