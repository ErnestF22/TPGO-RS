...
static typename MapType::mapped_type findValueInMap(const MapType &map,
                                                    const InputType &key)
{
...
namespace datatypes {
namespace utils {
static images::datatypes::UnderlyingType
getUnderlyingTypeFromName(const std::string &className)
{
  ...
  static const ClassMap classMap{
      {"logical", UnderlyingType::Logical}, {"uint8", UnderlyingType::Uint8},
      {"int8", UnderlyingType::Int8},       {"uint16", UnderlyingType::Uint16},
      {"int16", UnderlyingType::Int16},     {"uint32", UnderlyingType::Uint32},
      {"int32", UnderlyingType::Int32},     {"single", UnderlyingType::Single},
...
static std::string
getUnderlyingTypeName(const images::datatypes::UnderlyingType dtype)
{
  ...
  static const DatatypeNameMap datatypeNameMap{
      {UnderlyingType::Logical, "logical"}, {UnderlyingType::Uint8, "uint8"},
      {UnderlyingType::Int8, "int8"},       {UnderlyingType::Uint16, "uint16"},
      {UnderlyingType::Int16, "int16"},     {UnderlyingType::Uint32, "uint32"},
      {UnderlyingType::Int32, "int32"},     {UnderlyingType::Single, "single"},
...
static uint8_t
getUnderlyingTypeValue(const images::datatypes::UnderlyingType dtype)
{
  return static_cast<uint8_t>(dtype);
}

static images::datatypes::ColorFormat
getColorFormatFromName(const std::string &pixelLayout)
{
  using namespace images::datatypes;
  ...
  static const ColorFormatMap formatMap{
      {"BGRA", ColorFormat::BGRA},     {"RGB", ColorFormat::RGB},
      {"BGR", ColorFormat::BGR},       {"Grayscale", ColorFormat::Grayscale},
      {"Binary", ColorFormat::Binary}, {"Generic", ColorFormat::Generic}};

  return findValueInMap(formatMap, pixelLayout);
}

static std::string
getColorFormatName(const images::datatypes::ColorFormat format)
{
  ...
  static const ColorFormatNameMap formatNameMap{
      {ColorFormat::BGRA, "BGRA"},     {ColorFormat::RGB, "RGB"},
      {ColorFormat::BGR, "BGR"},       {ColorFormat::Grayscale, "Grayscale"},
      {ColorFormat::Binary, "Binary"}, {ColorFormat::Generic, "Generic"}};
...
static images::datatypes::Layout getLayoutFromName(const std::string &layout)
{
  ...
  static const LayoutMap layoutMap{{"RowMajor", Layout::RowMajor},
...
static std::string getLayoutName(const images::datatypes::Layout layout)
{
  ...
  static const LayoutNameMap layoutNameMap{
      {Layout::RowMajor, "RowMajor"}, {Layout::ColumnMajor, "ColumnMajor"}};
