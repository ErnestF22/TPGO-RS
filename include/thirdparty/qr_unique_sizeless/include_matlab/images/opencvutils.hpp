...
/**
  ...
  *
  * cv::Mat does not maintain any notion of the channel order of the data
  present.
  ...
  */
IMAGESDATATYPESOPENCVUTILS_API cv::Mat
convertToCvMat(const images::datatypes::Image &im, bool isCopyData = true);
} // namespace opencvutils
} // namespace datatypes
} // namespace images
