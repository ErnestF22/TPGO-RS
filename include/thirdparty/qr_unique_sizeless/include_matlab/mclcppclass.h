 ...
 * It is awkward to modify the existing constructors to accommodate the creation
 * of array of MATLAB string type. With this enum as a parameter in the
 * constructors, similar constructors can be adapted for MATLAB string type. It
 * has one member as of now, but the list can be expanded when the need arises.
 * Use enum instead of enum class since C++ 11 or later is not a requirement.
 */
enum MWObjectType
{
  MLString
...
static const char *STRING_ONLY_METHOD_ERROR =
    "Method can only be called on a MATLAB string.";

template <class T> class mwArraySharedCopy : public T {
private:
...
class mwArray {
  friend void mclcppMlfFeval(HMCRINSTANCE inst, const char *name, int nargout,
                             int fnout, int fnin, ...);
...
public:
  ...
  mwArray(mwSize num_rows, mwSize num_cols, mxClassID mxID,
      ...
      : m_pa(0)
  {
    if (mclGetMatrix((void **)&m_pa, num_rows, num_cols, mxID, cmplx) ==
        MCLCPP_ERR)
      mwException::raise_error();
    validate();
  }
  ...
  {
    if (mclGetCharMatrixFromStrings((void **)&m_pa, num_strings, str) ==
        MCLCPP_ERR)
      mwException::raise_error();
    validate();
  }
  mwArray(mwSize num_rows, mwSize num_cols, int num_fields,
      ...
      : m_pa(0)
  {
    if (mclGetStructMatrix((void **)&m_pa, num_rows, num_cols, num_fields,
                           fieldnames) == MCLCPP_ERR)
      mwException::raise_error();
    validate();
  }
  mwArray(mwSize num_dims, const mwSize *dims, int num_fields,
      ...
      : m_pa(0)
  {
    if (mclGetStructArray((void **)&m_pa, num_dims, dims, num_fields,
                          fieldnames) == MCLCPP_ERR)
      mwException::raise_error();
    validate();
  }
...
public:
  ...
  {
    array_ref *p = array_ref_get_const_char(m_pa, name, num_indices, index);
    if (!p)
      mwException::raise_error();
    return mwArray(p);
  }
  const mwArray GetA(const char *name, mwSize num_indices,
                     const mwIndex *index) const
  {
    array_ref *p = array_ref_get_const_char(m_pa, name, num_indices, index);
    if (!p)
      mwException::raise_error();
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5)
  {
    return GetPromoted(5, i1, i2, i3, i4, i5);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6)
  {
    return GetPromoted(6, i1, i2, i3, i4, i5, i6);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7)
  {
    return GetPromoted(7, i1, i2, i3, i4, i5, i6, i7);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8)
  {
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10)
  {
    return GetPromoted(10, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11)
  {
    return GetPromoted(11, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12)
  {
    return GetPromoted(12, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13)
  {
    return GetPromoted(13, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              ...
              mwIndex i14)
  {
    return GetPromoted(14, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15)
  {
    return GetPromoted(15, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16)
  {
    return GetPromoted(16, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17)
  {
    return GetPromoted(17, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18)
  {
    return GetPromoted(18, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i19)
  {
    return GetPromoted(19, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20)
  {
    return GetPromoted(20, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21)
  {
    return GetPromoted(21, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22)
  {
    return GetPromoted(22, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13,
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23)
  {
    return GetPromoted(23, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i24)
  {
    return GetPromoted(24, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25)
  {
    return GetPromoted(25, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25, mwIndex i26)
  {
    return GetPromoted(26, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25, mwIndex i26, mwIndex i27)
  {
    return GetPromoted(27, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28)
  {
    return GetPromoted(28, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28);
  }
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i29)
  {
    return GetPromoted(29, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28,
              mwIndex i29, mwIndex i30)
  {
    return GetPromoted(30, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28,
              mwIndex i29, mwIndex i30, mwIndex i31)
  {
    return GetPromoted(31, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
              ...
              mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
              mwIndex i24, mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28,
              mwIndex i29, mwIndex i30, mwIndex i31, mwIndex i32)
  {
    return GetPromoted(32, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2,
                    mwIndex i3) const
  {
    return GetPromoted(3, i1, i2, i3);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4) const
  {
    return GetPromoted(4, i1, i2, i3, i4);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5) const
  {
    return GetPromoted(5, i1, i2, i3, i4, i5);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6) const
  {
    return GetPromoted(6, i1, i2, i3, i4, i5, i6);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7) const
  {
    return GetPromoted(7, i1, i2, i3, i4, i5, i6, i7);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                    mwIndex i9, mwIndex i10) const
  {
    return GetPromoted(10, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                    mwIndex i9, mwIndex i10, mwIndex i11) const
  {
    return GetPromoted(11, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12) const
  {
    return GetPromoted(12, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                    mwIndex i13, mwIndex i14, mwIndex i15) const
  {
    return GetPromoted(15, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16) const
  {
    return GetPromoted(16, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17) const
  {
    return GetPromoted(17, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17);
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17, mwIndex i18, mwIndex i19) const
  {
    return GetPromoted(19, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20) const
  {
    return GetPromoted(20, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21) const
  {
    return GetPromoted(21, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21);
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21, mwIndex i22, mwIndex i23) const
  {
    return GetPromoted(23, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23);
  }
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24) const
  {
    return GetPromoted(24, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24);
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24,
                    mwIndex i25) const
  {
    return GetPromoted(25, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24,
                    mwIndex i25, mwIndex i26, mwIndex i27) const
  {
    return GetPromoted(27, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27);
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24,
                    mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28) const
  {
    return GetPromoted(28, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28);
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24,
                    mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28,
                    mwIndex i29) const
  {
    return GetPromoted(29, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24,
                    mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28,
                    mwIndex i29, mwIndex i30, mwIndex i31) const
  {
    return GetPromoted(31, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28, i29, i30, i31);
  ...
  const mwArray Get(mwSize num_indices, mwIndex i1, mwIndex i2, mwIndex i3,
                    ...
                    mwIndex i21, mwIndex i22, mwIndex i23, mwIndex i24,
                    mwIndex i25, mwIndex i26, mwIndex i27, mwIndex i28,
                    mwIndex i29, mwIndex i30, mwIndex i31, mwIndex i32) const
  {
    return GetPromoted(32, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28, i29, i30, i31, i32);
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4)
  {
    return GetPromoted(name, 4, i1, i2, i3, i4);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5)
  {
    return GetPromoted(name, 5, i1, i2, i3, i4, i5);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6)
  {
    return GetPromoted(name, 6, i1, i2, i3, i4, i5, i6);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7)
  {
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9)
  {
    return GetPromoted(name, 9, i1, i2, i3, i4, i5, i6, i7, i8, i9);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9, mwIndex i10)
  {
    return GetPromoted(name, 10, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11)
  {
    return GetPromoted(name, 11, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12)
  {
    return GetPromoted(name, 12, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              ...
              mwIndex i13)
  {
    return GetPromoted(name, 13, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14)
  {
    return GetPromoted(name, 14, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14, mwIndex i15)
  {
    return GetPromoted(name, 15, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              ...
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16)
  {
    return GetPromoted(name, 16, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17)
  {
    return GetPromoted(name, 17, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i18)
  {
    return GetPromoted(name, 18, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19)
  {
    return GetPromoted(name, 19, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20)
  {
    return GetPromoted(name, 20, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21)
  {
    return GetPromoted(name, 21, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22)
  {
    return GetPromoted(name, 22, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
  ...
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i23)
  {
    return GetPromoted(name, 23, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
              mwIndex i23, mwIndex i24)
  {
    return GetPromoted(name, 24, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
              mwIndex i23, mwIndex i24, mwIndex i25)
  {
    return GetPromoted(name, 25, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
              mwIndex i23, mwIndex i24, mwIndex i25, mwIndex i26)
  {
    return GetPromoted(name, 26, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25, i26);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
              mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
              mwIndex i23, mwIndex i24, mwIndex i25, mwIndex i26, mwIndex i27)
  {
    return GetPromoted(name, 27, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25, i26, i27);
  }
  mwArray Get(const char *name, mwSize num_indices, mwIndex i1, mwIndex i2,
              ...
              mwIndex i28)
  {
    return GetPromoted(name, 28, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  {
    return GetPromoted(name, 29, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  {
    return GetPromoted(name, 30, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  {
    return GetPromoted(name, 31, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  {
    return GetPromoted(name, 32, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2) const
  {
    return GetPromoted(name, 2, i1, i2);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3) const
  {
    return GetPromoted(name, 3, i1, i2, i3);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4) const
  {
    return GetPromoted(name, 4, i1, i2, i3, i4);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5) const
  {
    return GetPromoted(name, 5, i1, i2, i3, i4, i5);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                    mwIndex i6) const
  {
    return GetPromoted(name, 6, i1, i2, i3, i4, i5, i6);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7) const
  {
    return GetPromoted(name, 7, i1, i2, i3, i4, i5, i6, i7);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8) const
  {
    return GetPromoted(name, 8, i1, i2, i3, i4, i5, i6, i7, i8);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8, mwIndex i9) const
  {
    return GetPromoted(name, 9, i1, i2, i3, i4, i5, i6, i7, i8, i9);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10) const
  {
    return GetPromoted(name, 10, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11) const
  {
    return GetPromoted(name, 11, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11);
  }
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11, mwIndex i12, mwIndex i13) const
  {
    return GetPromoted(name, 13, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14) const
  {
    return GetPromoted(name, 14, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5, mwIndex i6,
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14,
                    mwIndex i15) const
  {
    return GetPromoted(name, 15, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15);
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14,
                    mwIndex i15, mwIndex i16, mwIndex i17) const
  {
    return GetPromoted(name, 17, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14,
                    mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18) const
  {
    return GetPromoted(name, 18, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i7, mwIndex i8, mwIndex i9, mwIndex i10,
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14,
                    mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
                    mwIndex i19) const
  {
    return GetPromoted(name, 19, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19);
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14,
                    mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
                    mwIndex i19, mwIndex i20, mwIndex i21) const
  {
    return GetPromoted(name, 21, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21);
  }
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i11, mwIndex i12, mwIndex i13, mwIndex i14,
                    mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
                    mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22) const
  {
    return GetPromoted(name, 22, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22);
  }
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
                    mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
                    mwIndex i23, mwIndex i24, mwIndex i25) const
  {
    return GetPromoted(name, 25, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25);
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i15, mwIndex i16, mwIndex i17, mwIndex i18,
                    mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
                    mwIndex i23, mwIndex i24, mwIndex i25, mwIndex i26) const
  {
    return GetPromoted(name, 26, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25, i26);
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
                    mwIndex i23, mwIndex i24, mwIndex i25, mwIndex i26,
                    mwIndex i27, mwIndex i28, mwIndex i29) const
  {
    return GetPromoted(name, 29, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25, i26, i27, i28, i29);
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
                    mwIndex i23, mwIndex i24, mwIndex i25, mwIndex i26,
                    mwIndex i27, mwIndex i28, mwIndex i29, mwIndex i30) const
  {
    return GetPromoted(name, 30, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25, i26, i27, i28, i29, i30);
  ...
  const mwArray Get(const char *name, mwSize num_indices, mwIndex i1,
                    ...
                    mwIndex i19, mwIndex i20, mwIndex i21, mwIndex i22,
                    mwIndex i23, mwIndex i24, mwIndex i25, mwIndex i26,
                    mwIndex i27, mwIndex i28, mwIndex i29, mwIndex i30,
                    mwIndex i31) const
  {
    return GetPromoted(name, 31, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  mwArray GetPromoted(const char *name, mwSize num_indices, ...)
  {
    va_list vargs;
    va_start(vargs, num_indices);
    array_ref *p = array_ref_getV_const_char(m_pa, name, num_indices, vargs);
    va_end(vargs);
    if (!p)
      mwException::raise_error();
    return mwArray(p);
  ...
  {
#ifdef _LP64
    if (array_ref_get_numeric_mxUint64(
            m_pa, static_cast<mxUint64 *>(static_cast<void *>(buffer)), len) ==
        MCLCPP_ERR)
      mwException::raise_error();
#else
    if (array_ref_get_numeric_mxUint32(
            m_pa, static_cast<mxUint32 *>(static_cast<void *>(buffer)), len) ==
        MCLCPP_ERR)
      mwException::raise_error();
#endif
  }
  ...
  void GetStringData(const mxChar **data, mwSize *array_size,
                     mwSize *data_size) const
  {
    if (array_ref_get_matlab_string(m_pa, data, array_size, data_size) ==
        MCLCPP_ERR)
      mwException::raise_error();
  }
  std::vector<mwUString> GetStringData() const
  {
    ...
    if (m > 0) {
      ...
      if (array_ref_get_matlab_string(m_pa, (const mxChar **)&data[0], &m,
                                      NULL) == MCLCPP_ERR)
        mwException::raise_error();
  ...
  {
#ifdef _LP64
    if (array_ref_set_numeric_mxUint64(
            m_pa, static_cast<mxUint64 *>(static_cast<void *>(buffer)) buffer,
            len) == MCLCPP_ERR)
      mwException::raise_error();
#else
    if (array_ref_set_numeric_mxUint32(
            m_pa, static_cast<mxUint32 *>(static_cast<void *>(buffer)), len) ==
        MCLCPP_ERR)
      mwException::raise_error();
#endif
  ...
  {
    if (static_cast<const mwArray *>(&arr) ==
        const_cast<const mwArray *>(this)) {
      return *this;
    }
    Set(arr);
    return *this;
  ...
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           mwIndex i5) const
  {
    return GetPromoted(5, i1, i2, i3, i4, i5);
  }
  ...
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           mwIndex i5, mwIndex i6) const
  {
    return GetPromoted(6, i1, i2, i3, i4, i5, i6);
  }
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     mwIndex i6, mwIndex i7)
  {
    return GetPromoted(7, i1, i2, i3, i4, i5, i6, i7);
  }
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           mwIndex i5, mwIndex i6, mwIndex i7) const
  {
    return GetPromoted(7, i1, i2, i3, i4, i5, i6, i7);
  }
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     mwIndex i6, mwIndex i7, mwIndex i8)
  {
    return GetPromoted(8, i1, i2, i3, i4, i5, i6, i7, i8);
  }
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8) const
  {
    return GetPromoted(8, i1, i2, i3, i4, i5, i6, i7, i8);
  }
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     mwIndex i6, mwIndex i7, mwIndex i8, mwIndex i9)
  {
    return GetPromoted(9, i1, i2, i3, i4, i5, i6, i7, i8, i9);
  }
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           mwIndex i5, mwIndex i6, mwIndex i7, mwIndex i8,
                           mwIndex i9) const
  {
    return GetPromoted(9, i1, i2, i3, i4, i5, i6, i7, i8, i9);
  }
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     mwIndex i6, mwIndex i7, mwIndex i8, mwIndex i9,
                     mwIndex i10, mwIndex i11, mwIndex i12)
  {
    return GetPromoted(12, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12);
  }
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     mwIndex i6, mwIndex i7, mwIndex i8, mwIndex i9,
                     mwIndex i10, mwIndex i11, mwIndex i12, mwIndex i13)
  {
    return GetPromoted(13, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13);
  }
  ...
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           ...
                           mwIndex i9, mwIndex i10, mwIndex i11, mwIndex i12,
                           mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                           mwIndex i17, mwIndex i18, mwIndex i19,
                           mwIndex i20) const
  {
    return GetPromoted(20, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20);
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     ...
                     mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
                     mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21,
                     mwIndex i22, mwIndex i23, mwIndex i24)
  {
    return GetPromoted(24, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24);
  ...
  const mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4,
                           ...
                           mwIndex i13, mwIndex i14, mwIndex i15, mwIndex i16,
                           mwIndex i17, mwIndex i18, mwIndex i19, mwIndex i20,
                           mwIndex i21, mwIndex i22, mwIndex i23,
                           mwIndex i24) const
  {
    return GetPromoted(24, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     ...
                     mwIndex i14, mwIndex i15, mwIndex i16, mwIndex i17,
                     mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21,
                     mwIndex i22, mwIndex i23, mwIndex i24, mwIndex i25)
  {
    return GetPromoted(25, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25);
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     ...
                     mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21,
                     mwIndex i22, mwIndex i23, mwIndex i24, mwIndex i25,
                     mwIndex i26, mwIndex i27, mwIndex i28)
  {
    return GetPromoted(28, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28);
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     ...
                     mwIndex i18, mwIndex i19, mwIndex i20, mwIndex i21,
                     mwIndex i22, mwIndex i23, mwIndex i24, mwIndex i25,
                     mwIndex i26, mwIndex i27, mwIndex i28, mwIndex i29)
  {
    return GetPromoted(29, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28, i29);
  ...
  mwArray operator()(mwIndex i1, mwIndex i2, mwIndex i3, mwIndex i4, mwIndex i5,
                     ...
                     mwIndex i22, mwIndex i23, mwIndex i24, mwIndex i25,
                     mwIndex i26, mwIndex i27, mwIndex i28, mwIndex i29,
                     mwIndex i30, mwIndex i31, mwIndex i32)
  {
    return GetPromoted(32, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
                       i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23,
                       i24, i25, i26, i27, i28, i29, i30, i31, i32);
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2,
                           mwIndex i3) const
  {
    return GetPromoted(name, 3, i1, i2, i3);
  }
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           mwIndex i4) const
  {
    return GetPromoted(name, 4, i1, i2, i3, i4);
  }
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
                           mwIndex i8, mwIndex i9, mwIndex i10) const
  {
    return GetPromoted(name, 10, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10);
  }
  mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
                           mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11,
                           mwIndex i12, mwIndex i13, mwIndex i14) const
  {
    return GetPromoted(name, 14, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14);
  }
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
                           mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11,
                           mwIndex i12, mwIndex i13, mwIndex i14,
                           mwIndex i15) const
  {
    return GetPromoted(name, 15, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15);
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           mwIndex i4, mwIndex i5, mwIndex i6, mwIndex i7,
                           mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11,
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16) const
  {
    return GetPromoted(name, 16, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16);
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11,
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16, mwIndex i17, mwIndex i18) const
  {
    return GetPromoted(name, 18, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18);
  }
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11,
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16, mwIndex i17, mwIndex i18,
                           mwIndex i19) const
  {
    return GetPromoted(name, 19, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19);
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i8, mwIndex i9, mwIndex i10, mwIndex i11,
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16, mwIndex i17, mwIndex i18, mwIndex i19,
                           mwIndex i20) const
  {
    return GetPromoted(name, 20, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20);
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16, mwIndex i17, mwIndex i18, mwIndex i19,
                           mwIndex i20, mwIndex i21, mwIndex i22) const
  {
    return GetPromoted(name, 22, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22);
  }
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16, mwIndex i17, mwIndex i18, mwIndex i19,
                           mwIndex i20, mwIndex i21, mwIndex i22,
                           mwIndex i23) const
  {
    return GetPromoted(name, 23, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i12, mwIndex i13, mwIndex i14, mwIndex i15,
                           mwIndex i16, mwIndex i17, mwIndex i18, mwIndex i19,
                           mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
                           mwIndex i24) const
  {
    return GetPromoted(name, 24, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
  ...
  const mwArray operator()(const char *name, mwIndex i1, mwIndex i2, mwIndex i3,
                           ...
                           mwIndex i16, mwIndex i17, mwIndex i18, mwIndex i19,
                           mwIndex i20, mwIndex i21, mwIndex i22, mwIndex i23,
                           mwIndex i24, mwIndex i25, mwIndex i26) const
  {
    return GetPromoted(name, 26, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11,
                       i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22,
                       i23, i24, i25, i26);
  ...
  static mwArray Deserialize(const mwArray &arrIn)
  {
    ...
    if (mclDeserializeArray(reinterpret_cast<void **>(&pOut), &pvIn) ==
        MCLCPP_ERR)
      mwException::raise_error();
    return mwArray(pOut);
  }
  static mwArray NewSparse(mwSize num_rows, mwSize num_cols, mwSize nzmax,
                           mxClassID mxID, mxComplexity cmplx = mxREAL)
  {
    array_ref *p = 0;
    int retval = 0;
    if (mxID == mxLOGICAL_CLASS) {
      retval = mclGetLogicalSparse((void **)&p, 0, NULL, 0, NULL, 0, NULL,
                                   num_rows, num_cols, nzmax);
    } else {
      retval = mclGetNumericSparse((void **)&p, 0, NULL, 0, NULL, 0, NULL, NULL,
                                   num_rows, num_cols, nzmax, mxID, cmplx);
    }
    if (retval) {
      mwException::raise_error();
    }
  ...
  static mwArray NewSparse(mwSize rowindex_size, const mwIndex *rowindex,
                           ...
                           mwSize data_size, const mxDouble *rData,
                           mwSize num_rows, mwSize num_cols, mwSize nzmax)
  {
    array_ref *p = 0;
    if (mclGetNumericSparse((void **)&p, rowindex_size, rowindex, colindex_size,
                            colindex, data_size, rData, NULL, num_rows,
                            num_cols, nzmax, mxDOUBLE_CLASS, mxREAL))
      mwException::raise_error();
    return mwArray(p);
  }
  static mwArray NewSparse(mwSize rowindex_size, const mwIndex *rowindex,
  ...
  {
    array_ref *p = 0;
    if (mclGetNumericSparseInferRowsCols(
            (void **)&p, rowindex_size, rowindex, colindex_size, colindex,
  ...
  static mwArray NewSparse(mwSize rowindex_size, const mwIndex *rowindex,
                           mwSize colindex_size, const mwIndex *colindex,
                           mwSize data_size, const mxDouble *rData,
                           const mxDouble *iData, mwSize num_rows,
                           mwSize num_cols, mwSize nzmax)
  {
    array_ref *p = 0;
    if (mclGetNumericSparse((void **)&p, rowindex_size, rowindex, colindex_size,
                            colindex, data_size, rData, iData, num_rows,
                            num_cols, nzmax, mxDOUBLE_CLASS, mxCOMPLEX))
      mwException::raise_error();
    return mwArray(p);
  }
  static mwArray NewSparse(mwSize rowindex_size, const mwIndex *rowindex,
                           mwSize colindex_size, const mwIndex *colindex,
                           mwSize data_size, const mxDouble *rData,
                           const mxDouble *iData, mwSize nzmax)
  {
    array_ref *p = 0;
    if (mclGetNumericSparseInferRowsCols(
            (void **)&p, rowindex_size, rowindex, colindex_size, colindex,
  ...
  static mwArray NewSparse(mwSize rowindex_size, const mwIndex *rowindex,
                           mwSize colindex_size, const mwIndex *colindex,
                           mwSize data_size, const mxLogical *rData,
                           mwSize num_rows, mwSize num_cols, mwSize nzmax)
  {
    array_ref *p = 0;
    if (mclGetLogicalSparse((void **)&p, rowindex_size, rowindex, colindex_size,
                            colindex, data_size, rData, num_rows, num_cols,
                            nzmax))
      mwException::raise_error();
    return mwArray(p);
  }
  ...
  {
    array_ref *p = 0;
    if (mclGetLogicalSparseInferRowsCols((void **)&p, rowindex_size, rowindex,
                                         colindex_size, colindex, data_size,
                                         rData, nzmax))
      mwException::raise_error();
    return mwArray(p);
  }
