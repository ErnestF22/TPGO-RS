...
private:
   ...
   */
  static size_t
  getDOFNumberFromMap(const std::vector<std::array<int32_T, 2>> &dofmap);
...
public:
  /// Default constructor
  RigidBodyTree() : m_RigidBodyVec{}, m_PositionDOFMap{}, m_VelocityDOFMap{}
  {
  }
  ...
  RigidBodyTree(const std::vector<RigidBody> &rbvec,
      ...
      : m_RigidBodyVec(rbvec), m_PositionDOFMap(pdofmap),
