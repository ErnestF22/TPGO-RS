...
// @{
extern int halide_opencl_initialize_kernels(void *user_context,
                                            void **state_ptr, const char *src,
                                            int size);
extern int halide_opencl_run(void *user_context, void *state_ptr,
...
extern int halide_opencl_wrap_cl_mem(void *user_context,
 ...
 * clCreateImage
 */
extern int halide_opencl_image_wrap_cl_mem(void *user_context,
                                           struct halide_buffer_t *buf,
                                           uint64_t device_ptr);
 ...
 */
extern int halide_opencl_detach_cl_mem(void *user_context,
                                       struct halide_buffer_t *buf);
 ...
 *  returns 0.
 */
extern uintptr_t halide_opencl_get_cl_mem(void *user_context,
                                          struct halide_buffer_t *buf);

/** Returns the offset associated with the OpenCL memory allocation via
 * device_crop or device_slice. */
extern uint64_t halide_opencl_get_crop_offset(void *user_context,
                                              halide_buffer_t *buf);
