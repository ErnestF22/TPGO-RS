...
LIBMWENGINE_PUBLISHED_API_EXTERN_C Engine *
...
LIBMWENGINE_PUBLISHED_API_EXTERN_C mxArray *engGetVariable(Engine *ep,
                                                           const char *name);

/* Put a variable into MATLAB's workspace with the specified name */
LIBMWENGINE_PUBLISHED_API_EXTERN_C int
engPutVariable(Engine *ep, const char *var_name, const mxArray *ap);

/* register a buffer to hold matlab text output */
LIBMWENGINE_PUBLISHED_API_EXTERN_C int engOutputBuffer(Engine *ep, char *buffer,
                                                       int buflen);
