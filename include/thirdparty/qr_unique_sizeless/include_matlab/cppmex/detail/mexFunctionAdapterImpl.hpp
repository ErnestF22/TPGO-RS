...
{
  static_assert(
      std::is_base_of<matlab::mex::Function, T>::value,
      "MexFunction class must be a subclass of matlab::mex::Function.");
  matlab::mex::Function *mexFunction = new T();
  return mexFunction;
}

inline void mexDestructorUtil(matlab::mex::Function *t)
{
  delete t;
}

inline void mexHandleException(void (*callbackErrHandler)(const char *,
                                                          const char *))
{
  try {
    throw;
...
MEXFUNCTION_LINKAGE
void *mexCreateMexFunction(void (*callbackErrHandler)(const char *,
                                                      const char *))
{
  try {
...
void mexDestroyMexFunction(void *mexFunc,
                           void (*callbackErrHandler)(const char *,
                                                      const char *))
{
  matlab::mex::Function *mexFunction =
      reinterpret_cast<matlab::mex::Function *>(mexFunc);
  try {
...
MEXFUNCTION_LINKAGE
void mexFunctionAdapter(int nlhs_, int nlhs, int nrhs, void *vrhs[], void *mFun,
                        void (*callbackOutput)(int, void **),
                        void (*callbackErrHandler)(const char *, const char *))
{

  matlab::mex::Function *mexFunction =
      reinterpret_cast<matlab::mex::Function *>(mFun);
...
void matlab::mex::Function::operator()(matlab::mex::ArgumentList outs,
                                       matlab::mex::ArgumentList ins)
{
  (void)ins;
  (void)outs;
}

inline std::shared_ptr<matlab::engine::MATLABEngine>
...
inline void matlab::mex::Function::mexLock()
{
  int errID = 0;
...
inline void matlab::mex::Function::mexUnlock()
{
  int errID = 0;
...
inline std::u16string matlab::mex::Function::getFunctionName() const
{
