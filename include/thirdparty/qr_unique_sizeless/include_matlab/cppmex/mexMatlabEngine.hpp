...
public:
   ...
   * @param output - The stream used to redirect standard output generated by
   * MATLAB
   * @param error - The stream used to redirect standard error generated by
   * MATLAB
   * @return std::vector<matlab::data::Array> - A vector of MATLAB Data Array as
   * the result of the MATLAB function
   *
   * @throw MATLABException
   */
  std::vector<matlab::data::Array>
  feval(const std::u16string &function, const int nlhs,
   ...
   */
  std::vector<matlab::data::Array>
  feval(const std::string &function, const int nlhs,
        const std::vector<matlab::data::Array> &args,
        const std::shared_ptr<StreamBuffer> &output =
            std::shared_ptr<StreamBuffer>(),
        const std::shared_ptr<StreamBuffer> &error =
   ...
   * @param error - The stream used to redirect standard error generated by
   * MATLAB
   * @return matlab::data::Array - A MATLAB Data Array as the result of the
   * MATLAB function
   *
   ...
   */
  template <class ReturnType, typename... RhsArgs>
  ReturnType feval(const std::u16string &function, RhsArgs &&...rhsArgs);

  /**
   * @overload
   */
  template <class ReturnType, typename... RhsArgs>
  ReturnType feval(const std::string &function, RhsArgs &&...rhsArgs);
   ...
   *
   * @param varName - The name of a MATLAB variable in the base or global
   * workspace
   * @return matlab::data::Array - The variable returned from MATLAB base or
   * global workspace
   *
   * @throw MATLABException
   */
  matlab::data::Array
  getVariable(const std::u16string &varName,
   ...
   * @overload
   */
  void setVariable(const std::string &varName, const matlab::data::Array &var,
                   WorkspaceType workspaceType = WorkspaceType::BASE);
   ...
   * @throw MATLABException
   */
  void setProperty(matlab::data::Array &object, size_t index,
                   const std::u16string &propertyName,
   ...
   * @overload
   */
  void setProperty(matlab::data::Array &object, const std::string &propertyName,
                   const matlab::data::Array &value);
   ...
   * @param error - The stream used to redirect standard error generated by
   * MATLAB
   * @return FutureResult<std::vector<matlab::data::Array>> - A future of a
   * vector of MATLAB Data Array as the result of the MATLAB function
   */
  FutureResult<std::vector<matlab::data::Array>>
  fevalAsync(const std::u16string &function, const int nlhs,
             const std::vector<matlab::data::Array> &args,
             const std::shared_ptr<StreamBuffer> &output =
                 std::shared_ptr<StreamBuffer>(),
             const std::shared_ptr<StreamBuffer> &error =
   ...
   */
  FutureResult<std::vector<matlab::data::Array>>
  fevalAsync(const std::string &function, const int nlhs,
             const std::vector<matlab::data::Array> &args,
             const std::shared_ptr<StreamBuffer> &output =
                 std::shared_ptr<StreamBuffer>(),
             const std::shared_ptr<StreamBuffer> &error =
   ...
   * @param error - The stream used to redirect standard error generated by
   * MATLAB
   * @return FutureResult<matlab::data::Array> - A future of a MATLAB Data Array
   * as the result of the MATLAB function
   */
  FutureResult<matlab::data::Array>
  fevalAsync(const std::u16string &function,
             const std::vector<matlab::data::Array> &args,
             const std::shared_ptr<StreamBuffer> &output =
                 std::shared_ptr<StreamBuffer>(),
             const std::shared_ptr<StreamBuffer> &error =
   ...
   */
  FutureResult<matlab::data::Array>
  fevalAsync(const std::string &function,
             const std::vector<matlab::data::Array> &args,
             const std::shared_ptr<StreamBuffer> &output =
                 std::shared_ptr<StreamBuffer>(),
             const std::shared_ptr<StreamBuffer> &error =
   ...
   */
  FutureResult<matlab::data::Array>
  fevalAsync(const std::u16string &function, const matlab::data::Array &arg,
             const std::shared_ptr<StreamBuffer> &output =
                 std::shared_ptr<StreamBuffer>(),
             const std::shared_ptr<StreamBuffer> &error =
                 std::shared_ptr<StreamBuffer>());
   ...
   */
  FutureResult<matlab::data::Array>
  fevalAsync(const std::string &function, const matlab::data::Array &arg,
             const std::shared_ptr<StreamBuffer> &output =
                 std::shared_ptr<StreamBuffer>(),
             const std::shared_ptr<StreamBuffer> &error =
                 std::shared_ptr<StreamBuffer>());
   ...
   * @param error - The stream used to redirect standard error generated by
   * MATLAB
   * @return FutureResult<ReturnType> - A future of the result of the MATLAB
   * function
   */
  template <class ReturnType, typename... RhsArgs>
   ...
   * @param varName - The name of a MATLAB variable in the base or global
   * workspace
   * @return FutureResult<matlab::data::Array> - A future of the variable
   * returned from MATLAB base or global workspace
   */
  FutureResult<matlab::data::Array>
  getVariableAsync(const std::u16string &varName,
                   WorkspaceType workspaceType = WorkspaceType::BASE);
   ...
   */
  FutureResult<matlab::data::Array>
  getVariableAsync(const std::string &varName,
                   WorkspaceType workspaceType = WorkspaceType::BASE);
   ...
   */
  FutureResult<void>
  setVariableAsync(const std::u16string &varName,
                   const matlab::data::Array &var,
                   WorkspaceType workspaceType = WorkspaceType::BASE);
   ...
   */
  FutureResult<void>
  setVariableAsync(const std::string &varName, const matlab::data::Array &var,
                   WorkspaceType workspaceType = WorkspaceType::BASE);
   ...
   * @param index - The index of the object of the object array
   * @param propertyName - The name of the property to set for the object
   * @return FutureResult<matlab::data::Array> - A future of the property from
   * the object
   */
  FutureResult<matlab::data::Array>
  getPropertyAsync(const matlab::data::Array &object, size_t index,
                   const std::u16string &propertyName);
   ...
   */
  FutureResult<matlab::data::Array>
  getPropertyAsync(const matlab::data::Array &object,
                   const std::u16string &propertyName);
   ...
   * @return FutureResult<void> - A future of the MATLAB command
   */
  FutureResult<void> setPropertyAsync(matlab::data::Array &object, size_t index,
                                      const std::u16string &propertyName,
                                      const matlab::data::Array &value);
