/**
 * Published header for C++ MEX Common Adapter
 *
 * Copyright 2024 The MathWorks, Inc.
 */

#ifndef __MEX_COMMON_FILE_ADAPTER_HPP__
#define __MEX_COMMON_FILE_ADAPTER_HPP__
...
#endif //__MEX_COMMON_FILE_ADAPTER_HPP__
