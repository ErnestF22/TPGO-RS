...
template <class T> class FutureResult;

template <class T> class SharedFutureResult;
...
public:
  ...
  /**
   * A constructor of FutureResult that accepts a standard future and a task
   * reference
   *
   * @param a_future - A standard future
  ...
  /**
   * A constructor of FutureResult that accepts a standard future, a task
   * reference, and buffers
   *
   * @param a_future - A standard future
   * @param a_taskreference - A shared pointer of task reference
   * @param outputBuffer - A shared pointer of StreamBuffer used to store
   * standard output
   * @param errorBuffer - A shared pointer of StreamBuffer used to store
   * standard error
   *
   * @throw none
   */
   ...
   * @throw none
   */
  FutureResult(FutureResult<T> &&a_futureresult) noexcept;
   ...
   * @throw none
   */
  FutureResult<T> &operator=(FutureResult<T> &&rhs) noexcept;
   ...
   * TypeConversionException, MatlabNotAvailableException, CancelledException,
   ...
   *
   * @param allowInterrupt - Interrupt the command or not if it is being
   * processed
...
template <class T> class SharedFutureResult : public std::shared_future<T> {
public:
  SharedFutureResult();
  ...
  /**
   * Swap the contents of this SharedFutureResult with another
   * SharedFutureResult
   *
