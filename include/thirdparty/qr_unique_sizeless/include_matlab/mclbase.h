...
LIBMWMCLBASE_API_EXTERN_C void mclSetLastErrIdAndMsg(const char *newid,
                                                     const char *newmsg);
...
LIBMWMCLBASE_API_EXTERN_C bool mclInitializeApplication(const char **options,
                                                        size_t count);
 ...
 */
LIBMWMCLBASE_API_EXTERN_C void separatePathName(const char *fullname, char *buf,
                                                size_t bufLen);
...
LIBMWMCLBASE_API_EXTERN_C mxArray *
mclCreateCellArrayFromArrayList(int narray, mxArray *parray[]);
...
LIBMWMCLBASE_API_EXTERN_C mxArray *
mclCreateSimpleFunctionHandle(mxFunctionPtr fcn);
...
LIBMWMCLBASE_API_EXTERN_C void
mclSetInterleavedCompatibility(bool bInterleavedCompatibility);
...
LIBMWMCLBASE_API_EXTERN_C int mclRunMain(mclMainFcnType run_main, int argc,
                                         const char **argv);
...
LIBMWMCLBASE_API_EXTERN_C void mclGetInstallBinArch(mxChar **installBinArch);
