...
public:
   ...
   * @param[in] rot relative rotation between view 1 and view 2, specified as a
   * cv::Matx33d.
   * @param[in] loc relative translation between view 1 and view 2, specified as
   * a cv::Vec3d.
   * @param[in] matches indices of matched features, specified as a vector of
   * index pairs.
   */
  Connection(const int viewId1, const int viewId2, const cv::Matx33d &rot,
