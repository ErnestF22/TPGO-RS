...
EXTERN_C LIBMWVSLAMCORE_API void *MonoVisualSLAM_constructor(
    const double fx, const double fy, const double cx, const double cy,
    const BaseParams *baseParams, const IMUParams *imuParams,
    const char *vocabFile, const int threadLevel,
    const double *camToIMU); // row-major 4-by-4 transform matrix

EXTERN_C LIBMWVSLAMCORE_API void MonoVisualSLAM_addFrame(
    void *objPtr,
...
EXTERN_C LIBMWVSLAMCORE_API void MonoVisualSLAM_storeGravityRotationAndScale(
    void *objPtr,
