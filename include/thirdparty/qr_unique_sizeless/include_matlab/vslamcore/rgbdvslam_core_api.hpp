...
RGBDVisualSLAM_constructor(const double fx, const double fy, const double cx,
                           const double cy, const BaseParams *baseParams,
                           const RGBDParams *rgbdParams, const char *vocabFile,
                           const int threadLevel);

EXTERN_C LIBMWVSLAMCORE_API void RGBDVisualSLAM_addFrame(
    void *objPtr,
