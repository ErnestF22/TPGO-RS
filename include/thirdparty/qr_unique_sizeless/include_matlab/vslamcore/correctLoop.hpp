 ...
 * @param[in] currKeyFrameId frame ID of the current key frame, specified as an
 * integer.
...
bool correctLoop(MapPointSet &mpSet, KeyFrameSet &kfSet,
                 LoopClosureDatabase &database, const cv::Matx33d &intrinsics,
