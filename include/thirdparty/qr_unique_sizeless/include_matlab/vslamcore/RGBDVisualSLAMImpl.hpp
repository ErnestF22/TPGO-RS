...
OutputIt set_difference_index(InputIt1 first1, InputIt1 last1, InputIt2 first2,
...
class LIBMWVSLAMCORE_API RGBDVisualSLAMImpl
    : public BaseVisualSLAMImpl<QueueInstanceRGBD, ConfigurationRGBD> {
...
public:
  ...
  RGBDVisualSLAMImpl(
      ...
      const ConfigurationRGBD &configuration, const char *vocabFile,
...
private:
   ...
   */
  void addNewMapPoints(QueueInstanceRGBD &qObj,
