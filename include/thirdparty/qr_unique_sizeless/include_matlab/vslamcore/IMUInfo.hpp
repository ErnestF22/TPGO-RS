...
struct IMUInfo {
  ...
  IMUInfo()
      : numKeyFramesPostAlignment{0}, poseScale{1}, isIMUAligned{false},
        isGSAvailable{false}, gravityRotationTransform(cv::Matx44d::eye()),
        camToIMUTransform(cv::Matx44d::eye())
  {
  } // default Constructor
  ...
  // 4x4 transform containing the rotation needed to align the camera global
  // frame with the IMU local frame
