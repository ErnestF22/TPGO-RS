...
public:
   ...
   *
   * @param[in] pointId Id of world point, specified as an integer.
   * @param[in] kfSet a keyFrameSet object containing views that observe the
   * world point.
   */
   ...
   *
   * @param[in] pointId Id of world point, specified as an integer.
   * @param[in] viewId Id of the view observing the world point, specified as an
   * integer.
   * @param[in] featureIdx index of the feature point corresponding to the world
   * point, specified as an integer.
   * @param[in] kfSet a keyFrameSet object containing views that observe the
   * world point.
   */
  void addCorrespondence(const int pointId, const int viewId,
                         const int featureIdx, KeyFrameSet &kfSet);
   ...
   * world point.
   */
  void removeCorrespondence(const int pointId, const int viewId,
                            KeyFrameSet &kfSet);
  ...
  /**
   * @brief Updates the representative view ID and corresponding feature index
   * of a world point
   *
   * @param[in] pointId Id of world point, specified as an integer.
   * @param[in] kfSet a keyFrameSet object containing views that observe the
   ...
   *
   * @param[in] pointId Id of world point, specified as an integer.
   * @param[in] flag a boolean value indicating if a map point is in the local
   * map.
   */
  void setLocal(const int pointId, const bool flag);

  /**
   * @brief Set a map point to be invalid. The correspondence between the world
   * point and the key frames observing it are deleted.
   *
   * @param[in] pointId Id of world point, specified as an integer.
   * @param[in] kfSet a keyFrameSet object containing views that observe the
   * world point.
