...
public:
   ...
   * @param[in] location [X, Y, Z] location of the world point, specified as a
   * cv::Vec3d.
   */
   ...
   *
   * @param[in] viewId Id of the view that observes the world point, specified
   * as an integer.
   * @param[in] featureIdx index of the feature point in the view that
   * corresponds to the world point, specified as an integer.
   */
   ...
   *
   * @param[in] viewId Id of view that observes the world point, specified as an
   * integer.
   */
  void removeCorrespondence(const int viewId);

  /**
   * @brief Set a world point to be invalid. The correspondence between the
   * world point and all the key frames observing it will be deleted.
   *
   */
  void setInvalid();
