...
#define LIBMWMCLMCR_API_LIBMWMCLMCR_API_EXTERN_C                               \
  LIBMWMCLMCR_API_EXTERN_C LIBMWMCLMCR_API
#endif
...
LIBMWMCLMCR_API_EXTERN_C mclCtfStream mclGetStreamFromArraySrc(char *buffer,
                                                               int bufferSize);
...
LIBMWMCLMCR_API_EXTERN_C bool
mclInitializeComponentInstanceNonEmbeddedStandalone(
    HMCRINSTANCE *inst, const char *path_to_component,
    const char *component_name, mccTargetType ttype,
    mclOutputHandlerFcn error_handler, mclOutputHandlerFcn print_handler,
    const char *session_key);

LIBMWMCLMCR_API_EXTERN_C bool mclInitializeInstanceWithoutComponent(
    HMCRINSTANCE *inst, const char **options, size_t count,
    mclOutputHandlerFcn error_handler, mclOutputHandlerFcn print_handler);

LIBMWMCLMCR_API_EXTERN_C bool mclInitializeComponentInstanceCtfFileToCache(
    HMCRINSTANCE *inst, mclOutputHandlerFcn error_handler,
    mclOutputHandlerFcn print_handler, const char *ctfFileLocation);

LIBMWMCLMCR_API_EXTERN_C bool mclInitializeComponentInstanceEmbedded(
    HMCRINSTANCE *inst, mclOutputHandlerFcn error_handler,
    mclOutputHandlerFcn print_handler, mclCtfStream ctfStream,
    const char *session_key);

LIBMWMCLMCR_API_EXTERN_C bool mclInitializeComponentInstanceWithCallbk(
    HMCRINSTANCE *inst, mclOutputHandlerFcn error_handler,
    mclOutputHandlerFcn print_handler,
    mclReadCtfStreamFcn readCtfStream_handler, size_t ctfStreamSize);

LIBMWMCLMCR_API_EXTERN_C bool
mclInitializeComponentInstanceFromExtractedComponent(
    HMCRINSTANCE *inst, mclOutputHandlerFcn error_handler,
    mclOutputHandlerFcn print_handler, const char *component_id);

LIBMWMCLMCR_API_EXTERN_C bool
mclInitializeComponentInstanceFromExtractedLocation(
    HMCRINSTANCE *inst, mclOutputHandlerFcn error_handler,
    mclOutputHandlerFcn print_handler, const char *extractedLoc);
...
LIBMWMCLMCR_API_EXTERN_C const char *
getStandaloneFileName(const char *path_to_ctf, const char *component_name);

LIBMWMCLMCR_API_EXTERN_C bool
mclStandaloneGenericMain(size_t argc, const char **argv,
                         const char *ctfFileName, bool ExtractToComponentCache,
                         void *ctfSettings);
...
public:
  ...
  virtual array_ref *get(const char *name, mwSize num_indices,
                         const mwIndex *index) = 0;
  virtual array_ref *getV(mwSize num_indices, va_list vargs) = 0;
  virtual array_ref *getV(const char *name, mwSize num_indices,
                          va_list vargs) = 0;
  virtual int set(array_ref *p) = 0;
  virtual array_ref *real() = 0;
  virtual array_ref *imag() = 0;
  /* Virtual member functions can't be templated. Thus, we need to declare all
   * the ones we need. */
  ...
  virtual int get_string_element(mwSize index, const mxChar **str,
                                 mwSize *len) = 0;
  virtual int get_string_data(const mxChar **data, mwSize *array_size,
                              mwSize *data_size) = 0;
...
LIBMWMCLMCR_API_EXTERN_C int char_buffer_set_buffer(char_buffer *obj,
                                                    const char *str);

LIBMWMCLMCR_API_EXTERN_C int char_buffer_compare_to(char_buffer *obj,
                                                    char_buffer *p);
...
LIBMWMCLMCR_API_EXTERN_C char_buffer *array_ref_get_field_name(array_ref *obj,
                                                               int i);
...
LIBMWMCLMCR_API_EXTERN_C bool
array_ref_is_missing_string_element(array_ref *obj, mwSize index);
...
LIBMWMCLMCR_API_EXTERN_C array_ref *
array_ref_get_int(array_ref *obj, mwSize num_indices, const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C array_ref *
array_ref_get_const_char(array_ref *obj, const char *name, mwSize num_indices,
                         const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C array_ref *
array_ref_getV_int(array_ref *obj, mwSize num_indices, va_list vargs);

LIBMWMCLMCR_API_EXTERN_C array_ref *
array_ref_getV_const_char(array_ref *obj, const char *name, mwSize num_indices,
                          va_list vargs);
...
LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxDouble(array_ref *obj, mxDouble *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxSingle(array_ref *obj, mxSingle *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxInt8(array_ref *obj, mxInt8 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxUint8(array_ref *obj, mxUint8 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxInt16(array_ref *obj, mxInt16 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxUint16(array_ref *obj, mxUint16 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxInt32(array_ref *obj, mxInt32 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxUint32(array_ref *obj, mxUint32 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxInt64(array_ref *obj, mxInt64 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_get_numeric_mxUint64(array_ref *obj, mxUint64 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int array_ref_get_char(array_ref *obj, mxChar *x,
                                                mwSize len);

LIBMWMCLMCR_API_EXTERN_C int array_ref_get_string_element(array_ref *obj,
                                                          mwSize index,
                                                          const mxChar **str,
                                                          mwSize *len);

LIBMWMCLMCR_API_EXTERN_C int array_ref_get_matlab_string(array_ref *obj,
                                                         const mxChar **data,
                                                         mwSize *array_size,
                                                         mwSize *data_size);

LIBMWMCLMCR_API_EXTERN_C int array_ref_get_logical(array_ref *obj, mxLogical *x,
                                                   mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxDouble(array_ref *obj, const mxDouble *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxSingle(array_ref *obj, const mxSingle *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxInt8(array_ref *obj, const mxInt8 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxUint8(array_ref *obj, const mxUint8 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxInt16(array_ref *obj, const mxInt16 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxUint16(array_ref *obj, const mxUint16 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxInt32(array_ref *obj, const mxInt32 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxUint32(array_ref *obj, const mxUint32 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxInt64(array_ref *obj, const mxInt64 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_numeric_mxUint64(array_ref *obj, const mxUint64 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int array_ref_set_char(array_ref *obj, const mxChar *x,
                                                mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_string_element(array_ref *obj, mwSize index, const mxChar *x);

LIBMWMCLMCR_API_EXTERN_C int array_ref_set_matlab_string(array_ref *obj,
                                                         const mxChar **x,
                                                         mwSize array_size);

LIBMWMCLMCR_API_EXTERN_C int
array_ref_set_logical(array_ref *obj, const mxLogical *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C mwSize array_buffer_size(array_buffer *obj);

LIBMWMCLMCR_API_EXTERN_C array_ref *array_buffer_get(array_buffer *obj,
                                                     mwIndex offset);

LIBMWMCLMCR_API_EXTERN_C int array_buffer_set(array_buffer *obj, mwIndex offset,
                                              array_ref *p);

LIBMWMCLMCR_API_EXTERN_C int array_buffer_add(array_buffer *obj, array_ref *pa);

LIBMWMCLMCR_API_EXTERN_C int array_buffer_remove(array_buffer *obj,
                                                 mwIndex offset);

LIBMWMCLMCR_API_EXTERN_C int array_buffer_clear(array_buffer *obj);

LIBMWMCLMCR_API_EXTERN_C array_ref *
array_buffer_to_cell(array_buffer *obj, mwIndex offset, mwSize len);

LIBMWMCLMCR_API_EXTERN_C const char *error_info_get_message(error_info *obj);

LIBMWMCLMCR_API_EXTERN_C size_t error_info_get_stack_trace(error_info *obj,
                                                           char ***stack);
...
template <typename T> class mw_auto_ptr_t {
public:
  mw_auto_ptr_t()
  {
    m_p = 0;
...
LIBMWMCLMCR_API_EXTERN_C bool mclIsIdentical(mxArray *pArray1,
                                             mxArray *pArray2);

LIBMWMCLMCR_API_EXTERN_C int mclGetEmptyArray(void **ppv, mxClassID classid);

LIBMWMCLMCR_API_EXTERN_C int mclGetMatrix(void **ppv, mwSize num_rows,
                                          mwSize num_cols, mxClassID classid,
                                          mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetArray(void **ppv, mwSize num_dims,
                                         const mwSize *dims, mxClassID classid,
                                         mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetNumericMatrix(void **ppv, mwSize num_rows,
                                                 mwSize num_cols,
                                                 mxClassID mxID,
                                                 mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetNumericArray(void **ppv, mwSize num_dims,
                                                const mwSize *dims,
                                                mxClassID mxID,
                                                mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int
mclGetScalarDouble(void **ppv, mxDouble re, mxDouble im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int
mclGetScalarSingle(void **ppv, mxSingle re, mxSingle im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetScalarInt8(void **ppv, mxInt8 re, mxInt8 im,
                                              mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetScalarUint8(void **ppv, mxUint8 re,
                                               mxUint8 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetScalarInt16(void **ppv, mxInt16 re,
                                               mxInt16 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int
mclGetScalarUint16(void **ppv, mxUint16 re, mxUint16 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetScalarInt32(void **ppv, mxInt32 re,
                                               mxInt32 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int
mclGetScalarUint32(void **ppv, mxUint32 re, mxUint32 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetScalarInt64(void **ppv, mxInt64 re,
                                               mxInt64 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int
mclGetScalarUint64(void **ppv, mxUint64 re, mxUint64 im, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetCharMatrix(void **ppv, mwSize num_rows,
                                              mwSize num_cols);

LIBMWMCLMCR_API_EXTERN_C int mclGetCharArray(void **ppv, mwSize num_dims,
                                             const mwSize *dims);
...
LIBMWMCLMCR_API_EXTERN_C int mclGetCharMatrixFromStrings(void **ppv, mwSize m,
                                                         const char **str);

LIBMWMCLMCR_API_EXTERN_C bool mclIsMatlabString(const mxArray *pa);

LIBMWMCLMCR_API_EXTERN_C bool mclIsMissingStringElement(const mxArray *pa,
                                                        mwSize index);

LIBMWMCLMCR_API_EXTERN_C mxArray *mclCreateMatlabString(mwSize m,
                                                        const mxChar **strs);

LIBMWMCLMCR_API_EXTERN_C mxArray *
mclCreateMatlabStringArray(mwSize m, const mwSize *dims);

LIBMWMCLMCR_API_EXTERN_C int mclMatlabStringGetElement(const mxArray *src,
                                                       mwSize index,
                                                       const mxChar **str,
                                                       mwSize *len);

LIBMWMCLMCR_API_EXTERN_C int
mclMatlabStringSetElement(mxArray *src, mwSize index, const mxChar *str);

LIBMWMCLMCR_API_EXTERN_C int mclMatlabStringGetData(const mxArray *src,
                                                    const mxChar **data,
                                                    mwSize *array_size,
                                                    mwSize *data_size);

LIBMWMCLMCR_API_EXTERN_C int
mclMatlabStringSetData(mxArray *src, const mxChar **data, mwSize array_size);

LIBMWMCLMCR_API_EXTERN_C int
mclMatlabStringGetNumberOfDimensions(const mxArray *src, mwSize *num_dims);

LIBMWMCLMCR_API_EXTERN_C int mclMatlabStringGetDimensions(const mxArray *src,
                                                          const mwSize **dims);

LIBMWMCLMCR_API_EXTERN_C int
mclMatlabStringGetNumberOfElements(const mxArray *src, mwSize *num_elms);

LIBMWMCLMCR_API_EXTERN_C int mclGetMatlabString(void **ppv, mwSize m,
                                                const mxChar **strs);

LIBMWMCLMCR_API_EXTERN_C int mclGetMatlabStringArray(void **ppv, mwSize m,
                                                     const mwSize *dims);

LIBMWMCLMCR_API_EXTERN_C int mclGetLogicalMatrix(void **ppv, mwSize num_rows,
                                                 mwSize num_cols);

LIBMWMCLMCR_API_EXTERN_C int mclGetLogicalArray(void **ppv, mwSize num_dims,
                                                const mwSize *dims);

LIBMWMCLMCR_API_EXTERN_C int mclGetScalarLogical(void **ppv, mxLogical x);

LIBMWMCLMCR_API_EXTERN_C int mclGetCellMatrix(void **ppv, mwSize num_rows,
                                              mwSize num_cols);

LIBMWMCLMCR_API_EXTERN_C int mclGetCellArray(void **ppv, mwSize num_dims,
                                             const mwSize *dims);

LIBMWMCLMCR_API_EXTERN_C int mclGetStructMatrix(void **ppv, mwSize num_rows,
                                                mwSize num_cols, int nFields,
                                                const char **fieldnames);

LIBMWMCLMCR_API_EXTERN_C int mclGetStructArray(void **ppv, mwSize num_dims,
                                               const mwSize *dims, int nFields,
                                               const char **fieldnames);

LIBMWMCLMCR_API_EXTERN_C int
mclGetNumericSparse(void **ppv, mwSize rowindex_size, const mwSize *rowindex,
                    mwSize colindex_size, const mwSize *colindex,
                    mwSize data_size, const void *rData, const void *iData,
                    mwSize num_rows, mwSize num_cols, mwSize nzmax,
                    mxClassID mxType, mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int mclGetNumericSparseInferRowsCols(
    void **ppv, mwSize rowindex_size, const mwSize *rowindex,
    mwSize colindex_size, const mwSize *colindex, mwSize data_size,
    const void *rData, const void *iData, mwSize nzmax, mxClassID mxType,
    mxComplexity cmplx);

LIBMWMCLMCR_API_EXTERN_C int
mclGetLogicalSparse(void **ppv, mwSize rowindex_size, const mwIndex *rowindex,
                    mwSize colindex_size, const mwIndex *colindex,
                    mwSize data_size, const mxLogical *rData, mwSize num_rows,
                    mwSize num_cols, mwSize nzmax);

LIBMWMCLMCR_API_EXTERN_C int
mclGetLogicalSparseInferRowsCols(void **ppv, mwSize rowindex_size,
                                 const mwIndex *rowindex, mwSize colindex_size,
...
LIBMWMCLMCR_API_EXTERN_C int mclcppFeval(HMCRINSTANCE inst, const char *name,
                                         int nargout, void **lhs, void *rhs);
...
LIBMWMCLMCR_API_EXTERN_C int mclmxArray2ArrayHandle(void **pphArray,
                                                    mxArray *pmxArray);

LIBMWMCLMCR_API_EXTERN_C int mclArrayHandle2mxArray(mxArray **ppArrayImpl,
                                                    void *phArray);

LIBMWMCLMCR_API_EXTERN_C int mclMXArrayGetIndexArrays(mxArray **ppRows,
                                                      mxArray **ppColumns,
                                                      mxArray *pSrcArray);

LIBMWMCLMCR_API_EXTERN_C int mclMXArrayGet(mxArray **ppSrcElem,
                                           mxArray *pSrcArray,
                                           mwSize num_indices,
                                           const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C int mclMXArrayGetReal(mxArray **ppSrcElem,
                                               mxArray *pSrcArray,
                                               mwSize num_indices,
                                               const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C int mclMXArrayGetImag(mxArray **ppSrcElem,
                                               mxArray *pSrcArray,
                                               mwSize num_indices,
                                               const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C int mclMXArraySet(mxArray *pTrgArray,
                                           mxArray *pSrcElem,
                                           mwSize num_indices,
                                           const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C int mclMXArraySetReal(mxArray *pTrgArray,
                                               mxArray *pSrcElem,
                                               mwSize num_indices,
                                               const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C int mclMXArraySetImag(mxArray *pTrgArray,
                                               mxArray *pSrcElem,
                                               mwSize num_indices,
                                               const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C int mclMXArraySetLogical(mxArray *pTrgArray,
                                                  mxArray *pSrcElem,
                                                  mwSize num_indices,
                                                  const mwIndex *index);
...
LIBMWMCLMCR_API_EXTERN_C mxArray *
mclMxRefDeserialize(const void *pa, size_t len, size_t mvmNumber);
...
LIBMWMCLMCR_API_EXTERN_C mwIndex mclCalcSingleSubscript(const mxArray *pa,
                                                        mwSize num_dims,
                                                        const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C mxArray *
mclCreateCharMatrixFromUTF16Strings(mwSize m, const mxChar **strs);

LIBMWMCLMCR_API_EXTERN_C int mcl2DCharArrayToUTF16Strings(const mxArray *src,
                                                          mxChar **data,
                                                          mwSize *array_size);
...
LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_deep_copy(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C void array_handle_detach(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_shared_copy(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_serialize(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C size_t array_handle_element_size(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C mwSize
array_handle_number_of_elements(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C mwSize
array_handle_number_of_nonzeros(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C mwSize
array_handle_maximum_nonzeros(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C mwSize
array_handle_number_of_dimensions(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_get_dimensions(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C int array_handle_number_of_fields(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C char_buffer *
array_handle_get_field_name(array_handle handle, int i);
...
LIBMWMCLMCR_API_EXTERN_C bool array_handle_equals(array_handle handle,
                                                  array_handle p);

LIBMWMCLMCR_API_EXTERN_C int array_handle_compare_to(array_handle handle,
                                                     array_handle p);

LIBMWMCLMCR_API_EXTERN_C int array_handle_hash_code(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C char_buffer *
array_handle_to_string(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_row_index(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_column_index(array_handle handle);

LIBMWMCLMCR_API_EXTERN_C array_handle array_handle_get_int(
    array_handle handle, mwSize num_indices, const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C array_handle
array_handle_get_const_char(array_handle handle, const char *name,
                            mwSize num_indices, const mwIndex *index);

LIBMWMCLMCR_API_EXTERN_C array_handle array_handle_getV_int(array_handle handle,
                                                            mwSize num_indices,
                                                            va_list vargs);

LIBMWMCLMCR_API_EXTERN_C array_handle array_handle_getV_const_char(
    array_handle handle, const char *name, mwSize num_indices, va_list vargs);

LIBMWMCLMCR_API_EXTERN_C int array_handle_set(array_handle handle,
                                              array_handle p);
...
LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxDouble(array_handle handle, mxDouble *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxSingle(array_handle handle, mxSingle *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxInt8(array_handle handle, mxInt8 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxUint8(array_handle handle, mxUint8 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxInt16(array_handle handle, mxInt16 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxUint16(array_handle handle, mxUint16 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxInt32(array_handle handle, mxInt32 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxUint32(array_handle handle, mxUint32 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxInt64(array_handle handle, mxInt64 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_get_numeric_mxUint64(array_handle handle, mxUint64 *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int array_handle_get_char(array_handle handle,
                                                   mxChar *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int array_handle_get_logical(array_handle handle,
                                                      mxLogical *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxDouble(array_handle handle, const mxDouble *x,
                                  mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxSingle(array_handle handle, const mxSingle *x,
                                  mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxInt8(array_handle handle, const mxInt8 *x,
                                mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxUint8(array_handle handle, const mxUint8 *x,
                                 mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxInt16(array_handle handle, const mxInt16 *x,
                                 mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxUint16(array_handle handle, const mxUint16 *x,
                                  mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxInt32(array_handle handle, const mxInt32 *x,
                                 mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxUint32(array_handle handle, const mxUint32 *x,
                                  mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxInt64(array_handle handle, const mxInt64 *x,
                                 mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_numeric_mxUint64(array_handle handle, const mxUint64 *x,
                                  mwSize len);

LIBMWMCLMCR_API_EXTERN_C int array_handle_set_char(array_handle handle,
                                                   const mxChar *x, mwSize len);

LIBMWMCLMCR_API_EXTERN_C int
array_handle_set_logical(array_handle handle, const mxLogical *x, mwSize len);
...
LIBMWMCLMCR_API_EXTERN_C void mclAddCanonicalPathMacro(const char *macro,
                                                       const char *expansion);

LIBMWMCLMCR_API_EXTERN_C bool mclFeval(HMCRINSTANCE inst, const char *name,
...
LIBMWMCLMCR_API_EXTERN_C bool allocWcsStackPointer(pwcsStackPointer *ptr,
                                                   int newLen);

LIBMWMCLMCR_API_EXTERN_C int mwMbstowcs(pwcsStackPointer sp,
                                        const char *sourceString);

LIBMWMCLMCR_API_EXTERN_C void utf16_to_lcp_n_fcn(char *target,
                                                 int32_t *targetSize,
...
LIBMWMCLMCR_API_EXTERN_C CHAR16_T *
utf16_strncpy_fcn(CHAR16_T *dst, CHAR16_T const *src, int32_t n);
...
LIBMWMCLMCR_API_EXTERN_C bool mclSetGlobal(HMCRINSTANCE inst, const char *name,
                                           mxArray *px);

LIBMWMCLMCR_API_EXTERN_C bool mclIsStandaloneMode();

LIBMWMCLMCR_API_EXTERN_C bool mclImpersonationFeval(HMCRINSTANCE inst,
...
LIBMWMCLMCR_API_EXTERN_C bool mclGetGlobal(HMCRINSTANCE inst, const char *name,
                                           mxArray **ppx);

LIBMWMCLMCR_API_EXTERN_C long mclGetID(HMCRINSTANCE inst);

LIBMWMCLMCR_API_EXTERN_C int mclMain(HMCRINSTANCE inst, int argc,
                                     const char *argv[], const char *name,
                                     int nlhs);

LIBMWMCLMCR_API_EXTERN_C bool mclMlfVFeval(HMCRINSTANCE inst, const char *name,
                                           int nargout, int fnout, int fnin,
                                           va_list ap);

typedef void (*mclEventFunctionPtr)(void *context, int nlhs, mxArray *plhs[],
...
LIBMWMCLMCR_API_EXTERN_C bool mclMxIsA(HMCRINSTANCE inst, mxArray *pa,
                                       const char *cname);

LIBMWMCLMCR_API_EXTERN_C bool mclMxIsRef(mxArray *pa);

LIBMWMCLMCR_API_EXTERN_C bool mclMxRefIsA(mxArray *pa, const char *cname);
...
LIBMWMCLMCR_API_EXTERN_C
void mclMxRefSetProperty(mxArray *obj, mwIndex index, const char *propName,
