...
/*real32*/
EXTERN_C LIBMWCANNYTHRESHOLDING_TBB_API void
cannythresholding_real32_tbb(const real32_T *pDx, const real32_T *pDy,
                             const real32_T *pMag, const real64_T *pSize,
                             const real64_T lowThresh, boolean_T *pE);

/*real64*/
EXTERN_C LIBMWCANNYTHRESHOLDING_TBB_API void
cannythresholding_real64_tbb(const real64_T *pDx, const real64_T *pDy,
                             const real64_T *pMag, const real64_T *pSize,
                             const real64_T lowThresh, boolean_T *pE);
