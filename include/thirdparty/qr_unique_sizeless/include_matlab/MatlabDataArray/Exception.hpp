 ...
 *
 * Concrete exception classes can inherit from std::exception or its subclasses
 * (i.e. std::bad_malloc) ONLY in cases when they are leaf classes.
 *
 */
class Exception {
public:
...
using OutOfMemoryException =
    data::detail::ArrayException<matlab::Exception,
                                 data::ExceptionType::OutOfMemory>;
...
using InvalidMemoryLayoutException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidMemoryLayout>;
using InvalidDimensionsInRowMajorArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidDimensionsInRowMajorArray>;
using InvalidTypeInRowMajorArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidTypeInRowMajorArray>;
using SystemErrorException =
    detail::ArrayException<matlab::Exception, ExceptionType::SystemError>;
...
using FailedToLoadLibMatlabDataArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::FailedToLoadLibMatlabDataArray>;
using FailedToResolveSymbolException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::FailedToResolveSymbol>;
using WrongNumberOfEnumsSuppliedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::WrongNumberOfEnumsSupplied>;
using MustSpecifyClassNameException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::MustSpecifyClassName>;
using TooManyIndicesProvidedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::TooManyIndicesProvided>;
using NotEnoughIndicesProvidedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::NotEnoughIndicesProvided>;
using StringIndexMustBeLastException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::StringIndexMustBeLast>;
using StringIndexNotValidException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::StringIndexNotValid>;
using CanOnlyUseOneStringIndexException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::CanOnlyUseOneStringIndex>;
using NonAsciiCharInInputDataException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::NonAsciiCharInInputData>;
using NonAsciiCharInRequestedAsciiOutputException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::NonAsciiCharInRequestedAsciiOutput>;
using InvalidDimensionsInSparseArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidDimensionsInSparseArray>;
using DuplicateFieldNameInStructArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::DuplicateFieldNameInStructArray>;
using CantIndexIntoEmptyArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::CantIndexIntoEmptyArray>;
using FeatureNotSupportedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::FeatureNotSupported>;
using NumberOfElementsExceedsMaximumException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::NumberOfElementsExceedsMaximum>;
using ObjectArrayIncompatibleTypesException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidHeterogeneousArray>;
using AccessingObjectNotSupportedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::ObjectNotAccessible>;
using InvalidNumberOfElementsProvidedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidNumberOfElementsProvided>;
...
using WrongVectorSizeForStructException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::WrongVectorSizeForStruct>;
...
using CouldNotCallConstructorException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::CouldNotCallConstructor>;
using HandleObjectNotFoundException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::HandleObjectNotFound>;
using InvalidHeterogeneousClassException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidHeterogeneousClass>;
using InvalidHandleObjectTypeException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidHandleObjectType>;
...
using RecursionLimitExceededException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::RecursionLimitExceeded>;
...
using InvalidPropertyValueException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidPropertyValue>;
using FailedToSerializeObjectException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::FailedToSerializeObject>;
using InvalidEnumerationNameException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidEnumerationName>;
...
using UnSuppportedOperationException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::UnSuppportedOperation>;
using ObjectSerializationFailedException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::ObjectSerializationFailed>;
...
using InvalidAssignmentForContainerArrayException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidAssignmentForContainerArray>;
using InvalidUTF8InputException =
    detail::ArrayException<matlab::Exception, ExceptionType::InvalidUTF8Input>;
using InvalidUTF16toUTF8ConversionException =
    detail::ArrayException<matlab::Exception,
                           ExceptionType::InvalidUTF16toUTF8Conversion>;
