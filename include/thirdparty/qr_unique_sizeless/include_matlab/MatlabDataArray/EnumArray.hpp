...
public:
   ...
   * @throw none
   */
  EnumArray(const EnumArray &rhs) MW_NOEXCEPT : TypedArray<Enumeration>(rhs)
  {
  }
   ...
   */
  EnumArray(const Array &rhs) : TypedArray<Enumeration>(rhs)
  {
  }
   ...
   * @throw InvalidArrayTypeException if type of rhs type is not ENUM
   */
  EnumArray(Array &&rhs) : TypedArray<Enumeration>(std::move(rhs))
  {
  }
  ...
  std::string getClassName() const MW_NOEXCEPT
  {
    ...
    size_t strlen = 0;
    typedef void (*EnumArrayGetClassFcnPtr)(impl::ArrayImpl *, const char **,
                                            size_t *);
    static const EnumArrayGetClassFcnPtr fcn =
        detail::resolveFunction<EnumArrayGetClassFcnPtr>(
...
private:
  ...
  EnumArray(impl::ArrayImpl *impl) MW_NOEXCEPT : TypedArray<Enumeration>(impl)
  {
  }
