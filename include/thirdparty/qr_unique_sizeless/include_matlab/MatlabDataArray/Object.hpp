...
public:
   ...
   * @throw none
   */
  Object(Object &&rhs) MW_NOEXCEPT : pImpl(std::move(rhs.pImpl))
  {
  }
   ...
   * @throw none
   */
  Object(const Object &rhs) MW_NOEXCEPT : pImpl(rhs.pImpl)
  {
  }
...
protected:
  ...
  Object(std::shared_ptr<impl::ObjectImpl> impl) MW_NOEXCEPT : pImpl(impl)
  {
  }

  Object(matlab::data::impl::ObjectImpl *impl) MW_NOEXCEPT
      : pImpl(
            std::shared_ptr<impl::ObjectImpl>(impl, [](impl::ObjectImpl *ptr) {
              typedef void (*ObjectDestroyFcnPtr)(impl::ObjectImpl *);
              static const ObjectDestroyFcnPtr fcn =
                  detail::resolveFunction<ObjectDestroyFcnPtr>(
