...
public:
   ...
   * @throw none
   */
  CharArray(CharArray &&rhs) MW_NOEXCEPT : TypedArray<CHAR16_T>(std::move(rhs))
  {
  }
   ...
   * @throw none
   */
  CharArray(const CharArray &rhs) MW_NOEXCEPT : TypedArray<CHAR16_T>(rhs)
  {
  }
   ...
   */
  CharArray(Array &&rhs) : TypedArray<CHAR16_T>(std::move(rhs))
  {
  }
   ...
   * @throw InvalidArrayTypeException if type of rhs type is not CHAR
   */
  CharArray(const Array &rhs) : TypedArray<CHAR16_T>(rhs)
  {
  }
  ...
  String toUTF16() const MW_NOEXCEPT
  {
    ...
    static const CharArrayGetStringFcnPtr fcn =
        detail::resolveFunction<CharArrayGetStringFcnPtr>(
  ...
  std::string toAscii() const
  {
    const char16_t *strVal = nullptr;
    size_t strLen = 0;
    typedef int (*CharArrayGetAsciiFcnPtr)(impl::ArrayImpl *, const char16_t **,
                                           size_t *);
    static const CharArrayGetAsciiFcnPtr fcn =
        detail::resolveFunction<CharArrayGetAsciiFcnPtr>(
