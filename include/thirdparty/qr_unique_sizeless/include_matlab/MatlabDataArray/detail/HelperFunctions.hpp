...
public:
  ...
  {
    typedef matlab::data::impl::ArrayImpl *(*ArrayGetImplForWorkspaceFcnPtr)(
        matlab::data::impl::ArrayImpl *);
    static const ArrayGetImplForWorkspaceFcnPtr fcn =
        (ArrayGetImplForWorkspaceFcnPtr)get_function_ptr(static_cast<int>(
            detail::FunctionType::ARRAY_GET_IMPL_FOR_WORKSPACE));
  ...
  template <typename ImplT> static void releaseImplFromWorkspace(ImplT impl)
  {
    typedef void (*ArrayReleaseImplFromWorkspaceFcnPtr)(
        matlab::data::impl::ArrayImpl *);
    static const ArrayReleaseImplFromWorkspaceFcnPtr fcn =
        (ArrayReleaseImplFromWorkspaceFcnPtr)get_function_ptr(static_cast<int>(
            detail::FunctionType::ARRAY_RELEASE_IMPL_FROM_WORKSPACE));
    return fcn(impl);
  }
};
} // namespace detail
