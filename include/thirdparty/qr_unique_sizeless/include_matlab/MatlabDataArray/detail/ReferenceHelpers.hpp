...
inline typename std::enable_if<std::is_base_of<Array, U>::value &&
                               !std::is_same<Struct, T>::value>::type
validateReference(ReferenceImpl *impl, bool unshare)
{
  typedef int (*TypedArrayReferenceValidateTypeFcnPtr)(ReferenceImpl *, int,
                                                       bool);
  static const TypedArrayReferenceValidateTypeFcnPtr fcn =
      resolveFunction<TypedArrayReferenceValidateTypeFcnPtr>(
...
template <typename T, typename U>
inline typename std::enable_if<!std::is_base_of<Array, U>::value>::type
validateReference(ReferenceImpl *impl, bool unshare)
{
  static_assert(std::is_same<T, U>::value,
                "Reference type must match array type");
  typedef int (*ReferenceValidateIndexFcnPtr)(ReferenceImpl *);
  static const ReferenceValidateIndexFcnPtr fcn =
      resolveFunction<ReferenceValidateIndexFcnPtr>(
          FunctionType::REFERENCE_VALIDATE_INDEX);
  throwIfError(fcn(impl));
}

template <typename T>
inline typename std::enable_if<std::is_base_of<Array, T>::value>::type
validateUntypedReference(ReferenceImpl *impl)
{
  typedef int (*TypedArrayReferenceValidateTypeFcnPtr)(ReferenceImpl *, int,
                                                       bool);
  static const TypedArrayReferenceValidateTypeFcnPtr fcn =
...
validateUntypedReference(ReferenceImpl *impl)
{
  ...
  static const ReferenceValidateTypeFcnPtr fcn =
      resolveFunction<ReferenceValidateTypeFcnPtr>(
...
template <typename T>
inline typename std::enable_if<!std::is_base_of<Array, T>::value>::type
validateUntypedArrayReference(ReferenceImpl *impl)
{
  typedef int (*TypedArrayReferenceValidateTypeFcnPtr)(ReferenceImpl *, int,
                                                       bool);
  static const TypedArrayReferenceValidateTypeFcnPtr fcn =
...
template <> inline bool castToType<bool>(void *value, ArrayType type)
{
  switch (type) {
  case ArrayType::LOGICAL:
...
template <> inline CHAR16_T castToType<CHAR16_T>(void *value, ArrayType type)
{
  switch (type) {
  case ArrayType::CHAR:
...
template <typename U>
inline typename std::enable_if<std::is_arithmetic<U>::value, U &>::type
getElement(std::shared_ptr<ReferenceImpl> impl)
{
  void *value = nullptr;
  typedef int (*TypedReferenceGetPodValueFcnPtr)(ReferenceImpl *, void **);
  static const TypedReferenceGetPodValueFcnPtr fcn =
      resolveFunction<TypedReferenceGetPodValueFcnPtr>(
...
template <typename U>
inline typename std::enable_if<is_complex<U>::value, U>::type
getElement(std::shared_ptr<ReferenceImpl> impl)
{
  void *real = nullptr;
  void *imag = nullptr;
  typedef int (*TypedReferenceGetComplexValueFcnPtr)(ReferenceImpl *, void **,
                                                     void **);
  static const TypedReferenceGetComplexValueFcnPtr fcn =
      resolveFunction<TypedReferenceGetComplexValueFcnPtr>(
          FunctionType::TYPED_REFERENCE_GET_COMPLEX_VALUE);
  throwIfError(fcn(impl.get(), &real, &imag));
...
template <typename U>
inline typename std::enable_if<std::is_same<MATLABString, U>::value,
                               MATLABString>::type
getElement(std::shared_ptr<ReferenceImpl> impl)
{
  const char16_t *str = nullptr;
  size_t strlen = 0;
  typedef int (*StringGetValueFcnPtr)(ReferenceImpl *, const char16_t **,
                                      size_t *);
  static const StringGetValueFcnPtr fcn =
      resolveFunction<StringGetValueFcnPtr>(FunctionType::STRING_GET_VALUE);
...
template <typename U>
inline typename std::enable_if<std::is_same<Array, U>::value, Array>::type
getElement(std::shared_ptr<ReferenceImpl> impl)
{
  impl::ArrayImpl *arr_impl = nullptr;
  typedef void (*ArrayReferenceSharedCopyFcnPtr)(
      ReferenceImpl *, matlab::data::impl::ArrayImpl **);
  static const ArrayReferenceSharedCopyFcnPtr fcn =
      resolveFunction<ArrayReferenceSharedCopyFcnPtr>(
...
template <typename U>
inline typename std::enable_if<std::is_same<Struct, U>::value, Struct>::type
getElement(std::shared_ptr<ReferenceImpl> impl)
{
...
template <typename U>
inline typename std::enable_if<std::is_same<Object, U>::value, Object>::type
getElement(std::shared_ptr<ReferenceImpl> impl)
{
  impl::ObjectImpl *obj_impl = nullptr;
  char msg[100];
  typedef int (*ObjectSharedCopyFcnPtr)(ReferenceImpl *, impl::ObjectImpl **,
                                        char *);
  static const ObjectSharedCopyFcnPtr fcn =
      resolveFunction<ObjectSharedCopyFcnPtr>(FunctionType::OBJECT_SHARED_COPY);
...
setElement(ReferenceImpl *impl, U rhs, int type)
{
  typedef int (*TypedReferenceSetPodValueFcnPtr)(ReferenceImpl *, int, void *);
  static const TypedReferenceSetPodValueFcnPtr fcn =
      resolveFunction<TypedReferenceSetPodValueFcnPtr>(
          FunctionType::TYPED_REFERENCE_SET_POD_VALUE);
  throwIfError(fcn(impl, type, &rhs));
}

template <typename U>
inline typename std::enable_if<is_complex<U>::value>::type
setElement(ReferenceImpl *impl, U rhs, int type)
{
  typename U::value_type real = rhs.real();
  typename U::value_type imag = rhs.imag();

  typedef int (*TypedReferenceSetComplexValueFcnPtr)(ReferenceImpl *, int,
                                                     void *, void *);
  static const TypedReferenceSetComplexValueFcnPtr fcn =
      resolveFunction<TypedReferenceSetComplexValueFcnPtr>(
          FunctionType::TYPED_REFERENCE_SET_COMPLEX_VALUE);
  throwIfError(fcn(impl, type, &real, &imag));
}

template <typename U>
inline typename std::enable_if<std::is_same<String, U>::value>::type
setElement(ReferenceImpl *impl, U rhs, int)
{
  typedef int (*ReferenceSetChar16StringFcnPtr)(ReferenceImpl *,
                                                const char16_t *, size_t);
  static const ReferenceSetChar16StringFcnPtr fcn =
      resolveFunction<ReferenceSetChar16StringFcnPtr>(
          FunctionType::REFERENCE_SET_CHAR16_STRING);
  throwIfError(fcn(impl, rhs.c_str(), rhs.size()));
}

template <typename U>
inline typename std::enable_if<std::is_same<std::string, U>::value>::type
setElement(ReferenceImpl *impl, U rhs, int)
{
  typedef int (*ReferenceSetStringFcnPtr)(ReferenceImpl *, const char *,
                                          size_t);
  static const ReferenceSetStringFcnPtr fcn =
      resolveFunction<ReferenceSetStringFcnPtr>(
...
setElement(ReferenceImpl *impl, U rhs, int)
{
  typedef int (*ReferenceSetReferenceValueFcnPtr)(
      ReferenceImpl *, matlab::data::impl::ArrayImpl *);
  static const ReferenceSetReferenceValueFcnPtr fcn =
      resolveFunction<ReferenceSetReferenceValueFcnPtr>(
...
{
  char msg[100];
  typedef int (*ReferenceSetReferenceObjectFcnPtr)(
      ReferenceImpl *, matlab::data::impl::ObjectImpl *, char *);
  static const ReferenceSetReferenceObjectFcnPtr fcn =
      resolveFunction<ReferenceSetReferenceObjectFcnPtr>(
          FunctionType::REFERENCE_SET_REFERENCE_OBJECT);
  auto res =
      fcn(impl, Access::getImpl<matlab::data::impl::ObjectImpl>(rhs), msg);
  throwIfError(res, std::string(msg));
  return rhs;
}

template <typename U>
inline typename std::enable_if<std::is_same<MATLABString, U>::value>::type
setElement(ReferenceImpl *impl, U rhs, int)
{
  if (rhs) {
    String elem = *rhs;
    ...
    static const ReferenceSetMissingChar16StringFcnPtr fcn =
        resolveFunction<ReferenceSetMissingChar16StringFcnPtr>(
...
inline typename std::enable_if<!std::is_same<Enumeration, U>::value &&
                                   !std::is_same<MATLABString, U>::value,
                               std::string>::type
getString(ReferenceImpl *impl)
{
  throwIfError(static_cast<int>(ExceptionType::InvalidDataType));
}
...
getString(ReferenceImpl *impl)
{
  ...
  size_t strlen = 0;
  typedef int (*EnumArrayGetValueFcnPtr)(ReferenceImpl *, const char **,
                                         size_t *);
  static const EnumArrayGetValueFcnPtr fcn =
      resolveFunction<EnumArrayGetValueFcnPtr>(
...
getString(ReferenceImpl *impl)
{
  const char16_t *str = nullptr;
  size_t strlen = 0;
  typedef int (*StringGetValueFcnPtr)(ReferenceImpl *impl, const char16_t **,
                                      size_t *);
  static const StringGetValueFcnPtr fcn =
      resolveFunction<StringGetValueFcnPtr>(FunctionType::STRING_GET_VALUE);
  throwIfError(fcn(impl, &str, &strlen));
...
template <typename U>
inline typename std::enable_if<!std::is_same<Enumeration, U>::value &&
                               !std::is_same<MATLABString, U>::value>::type
setString(ReferenceImpl *impl, std::string rhs)
{
  throwIfError(static_cast<int>(ExceptionType::InvalidDataType));
}

template <typename U>
inline typename std::enable_if<std::is_same<Enumeration, U>::value>::type
setString(ReferenceImpl *impl, std::string rhs)
{
  typedef int (*EnumArraySetValueFcnPtr)(ReferenceImpl *, const char *, size_t);
  static const EnumArraySetValueFcnPtr fcn =
      resolveFunction<EnumArraySetValueFcnPtr>(
...
template <typename U>
inline typename std::enable_if<std::is_same<MATLABString, U>::value>::type
setString(ReferenceImpl *impl, String rhs)
{
...
template <typename U>
inline typename std::enable_if<std::is_same<MATLABString, U>::value>::type
setString(ReferenceImpl *impl, MATLABString rhs)
{
  setElement<MATLABString>(impl, std::move(rhs), 0);
}

inline ReferenceImpl *getRef(ReferenceImpl *impl, const char *field, size_t len,
                             bool unshare)
{
  ReferenceImpl *retVal = nullptr;
  size_t numIdx = 0;
  typedef int (*StructReferenceGetIndexFcnPtr)(ReferenceImpl *, const char *,
                                               size_t, size_t *);
  static const StructReferenceGetIndexFcnPtr fcn =
      resolveFunction<StructReferenceGetIndexFcnPtr>(
          FunctionType::STRUCT_REFERENCE_GET_INDEX);
  throwIfError(fcn(impl, field, len, &numIdx));
  typedef int (*ReferenceGetReferenceValueFcnPtr)(ReferenceImpl *, bool,
                                                  ReferenceImpl **);
  static const ReferenceGetReferenceValueFcnPtr fcn2 =
      resolveFunction<ReferenceGetReferenceValueFcnPtr>(
  ...
  static const ReferenceAddIndexFcnPtr fcn3 =
      resolveFunction<ReferenceAddIndexFcnPtr>(
...
castTo(std::shared_ptr<ReferenceImpl> impl)
{
  void *value = nullptr;
  typedef int (*TypedReferenceGetPodValueFcnPtr)(ReferenceImpl *, void **);
  static const TypedReferenceGetPodValueFcnPtr fcn =
  ...
  static const ReferenceGetContainerTypeFcnPtr fcn2 =
      resolveFunction<ReferenceGetContainerTypeFcnPtr>(
...
template <typename T, bool is_const_ref>
typename std::enable_if<std::is_base_of<Array, T>::value, T>::type
castTo(std::shared_ptr<ReferenceImpl> impl)
{
  typedef int (*TypedArrayReferenceValidateTypeFcnPtr)(ReferenceImpl *, int,
                                                       bool);
  static const TypedArrayReferenceValidateTypeFcnPtr fcn2 =
      resolveFunction<TypedArrayReferenceValidateTypeFcnPtr>(
          FunctionType::TYPED_ARRAY_REFERENCE_VALIDATE_TYPE);
...
template <typename T, bool is_const_ref>
typename std::enable_if<std::is_base_of<ReferenceHolder, T>::value, T>::type
castTo(std::shared_ptr<ReferenceImpl> impl)
{
...
castTo(std::shared_ptr<ReferenceImpl> impl)
{
  ...
  if (ArrayType(arrType) == ArrayType::ENUM) {
    const char *str = nullptr;
    size_t strlen = 0;
    typedef int (*EnumArrayGetValueFcnPtr)(ReferenceImpl *impl, const char **,
                                           size_t *);
    static const EnumArrayGetValueFcnPtr fcn =
        resolveFunction<EnumArrayGetValueFcnPtr>(
            FunctionType::ENUM_ARRAY_GET_VALUE);
  ...
  throw TypeMismatchException(
      std::string("Can't convert this element to a std::string"));
}
} // namespace detail
} // namespace data
} // namespace matlab
