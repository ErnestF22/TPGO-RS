...
public:
  ...
  {
    typedef detail::ForwardIteratorImpl *(*StructArrayBeginIdFcnPtr)(
        impl::ArrayImpl *);
    static const StructArrayBeginIdFcnPtr b_fcn =
        detail::resolveFunction<StructArrayBeginIdFcnPtr>(
            detail::FunctionType::STRUCT_ARRAY_BEGIN_ID);
    typedef detail::ForwardIteratorImpl *(*StructArrayEndIdFcnPtr)(
        impl::ArrayImpl *);
    static const StructArrayEndIdFcnPtr e_fcn =
        detail::resolveFunction<StructArrayEndIdFcnPtr>(
            detail::FunctionType::STRUCT_ARRAY_END_ID);
    return Range<ForwardIterator, MATLABFieldIdentifier const>(
        detail::Access::createObj<ForwardIterator<MATLABFieldIdentifier const>>(
            b_fcn(detail::Access::getImpl<impl::ArrayImpl>(*this))),
        detail::Access::createObj<ForwardIterator<MATLABFieldIdentifier const>>(
            e_fcn(detail::Access::getImpl<impl::ArrayImpl>(*this))));
  }
  ...
  size_t getNumberOfFields() const MW_NOEXCEPT
  {
    ...
    static const StructArrayGetNumFieldsFcnPtr fcn =
        detail::resolveFunction<StructArrayGetNumFieldsFcnPtr>(
...
private:
  ...
  StructArray(impl::ArrayImpl *impl) MW_NOEXCEPT : TypedArray<Struct>(impl)
  {
  }
};
} // namespace data
