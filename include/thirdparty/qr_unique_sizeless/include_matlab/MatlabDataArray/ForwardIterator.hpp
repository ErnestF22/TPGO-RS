...
public:
  ...
  ForwardIterator(const ForwardIterator<T> &rhs) MW_NOEXCEPT
      : fIndex(rhs.fIndex)
  {
    typedef detail::ForwardIteratorImpl *(*ForwardIteratorCloneFcnPtr)(
        detail::ForwardIteratorImpl *);
    static const ForwardIteratorCloneFcnPtr fcn =
        detail::resolveFunction<ForwardIteratorCloneFcnPtr>(
            detail::FunctionType::FORWARD_ITERATOR_CLONE);
    pImpl = std::shared_ptr<detail::ForwardIteratorImpl>(
        fcn(rhs.pImpl.get()), [](detail::ForwardIteratorImpl *ptr) {
          typedef void (*ForwardIteratorDestroyFcnPtr)(
              detail::ForwardIteratorImpl *);
          static const ForwardIteratorDestroyFcnPtr fcn2 =
              detail::resolveFunction<ForwardIteratorDestroyFcnPtr>(
  ...
  {
    ++fIndex;
    typedef void (*ForwardIteratorPlusPlusFcnPtr)(
        detail::ForwardIteratorImpl *);
    static const ForwardIteratorPlusPlusFcnPtr fcn =
        detail::resolveFunction<ForwardIteratorPlusPlusFcnPtr>(
  ...
  {
    typedef bool (*ForwardIteratorEqualFcnPtr)(detail::ForwardIteratorImpl *,
                                               detail::ForwardIteratorImpl *);
    static const ForwardIteratorEqualFcnPtr fcn =
        detail::resolveFunction<ForwardIteratorEqualFcnPtr>(
  ...
  /**
   * operator* return a shared copy of the element that the iterator is pointing
   * to
   *
  ...
  reference operator*() const MW_NOEXCEPT
  {
    ...
    typedef void (*ForwardIteratorGetRefFcnPtr)(detail::ForwardIteratorImpl *,
                                                detail::RefCounted **);
    static const ForwardIteratorGetRefFcnPtr fcn =
        detail::resolveFunction<ForwardIteratorGetRefFcnPtr>(
  ...
  reference operator[](const size_t &rhs) const MW_NOEXCEPT
  {
    ForwardIterator<T> temp(*this);
    temp.fIndex += rhs;
    typedef void (*ForwardIteratorIncrementFcnPtr)(
        detail::ForwardIteratorImpl *, size_t);
    static const ForwardIteratorIncrementFcnPtr fcn =
        detail::resolveFunction<ForwardIteratorIncrementFcnPtr>(
