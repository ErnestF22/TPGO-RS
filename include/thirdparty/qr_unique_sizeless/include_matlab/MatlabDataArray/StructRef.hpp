...
template <> class Reference<Struct> : public ReferenceHolder {
public:
  ...
  Reference<Array> operator[](std::string idx)
  {
    ...
    static const StructReferenceGetRefFcnPtr fcn =
        detail::resolveFunctionNoExcept<StructReferenceGetRefFcnPtr>(
            detail::FunctionType::STRUCT_REFERENCE_GET_REF);
    if (fcn == nullptr) {
      return detail::Access::createObj<Reference<Array>>(
          detail::getRef(pImpl.get(), idx.c_str(), idx.size(), true));
    }
    detail::ReferenceImpl *impl = nullptr;
    detail::throwIfError(
        fcn(pImpl.get(), idx.c_str(), idx.size(), true, &impl));
  ...
  Array operator[](std::string idx) const
  {
    ...
    typedef int (*StructGetFieldCopyFcnPtr)(
        detail::ReferenceImpl *, const char *, size_t, impl::ArrayImpl **);
    static const StructGetFieldCopyFcnPtr fcn =
        detail::resolveFunction<StructGetFieldCopyFcnPtr>(
  ...
  iterator begin() MW_NOEXCEPT
  {
    ...
    static const ArrayReferenceBeginFcnPtr str_fcn =
  ...
  iterator end() MW_NOEXCEPT
  {
    typedef detail::IteratorImpl *(*ArrayReferenceEndFcnPtr)(
        detail::ReferenceImpl *, bool);
    static const ArrayReferenceEndFcnPtr str_fcn =
...
private:
  ...
  Reference(detail::ReferenceImpl *impl) MW_NOEXCEPT : ReferenceHolder(impl)
  {
  }
