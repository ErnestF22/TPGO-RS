...
public:
   ...
   * @throw none
   */
  Range(IteratorType<ElementType> begin,
        IteratorType<ElementType> end) MW_NOEXCEPT : fBegin(std::move(begin)),
                                                     fEnd(std::move(end))
  {
  }
   ...
   * @throw none
   */
  Range(Range &&rhs) MW_NOEXCEPT : fBegin(std::move(rhs.fBegin)),
