...
/**
 * The ArrayReferenceExt class is a base class for all reference types that
 * refer to Arrays. It provides basic Array information.
 */
...
public:
  ...
  ArrayType getType() const
  {
    ...
    static const ArrayReferenceGetTypeFcnPtr fcn =
        detail::resolveFunction<ArrayReferenceGetTypeFcnPtr>(
  ...
  ArrayDimensions getDimensions() const
  {
    size_t numDims = 0;
    size_t *dims = nullptr;
    typedef int (*ArrayReferenceGetDimensionsFcnPtr)(detail::ReferenceImpl *,
                                                     size_t *, size_t **);
    static const ArrayReferenceGetDimensionsFcnPtr fcn =
        detail::resolveFunction<ArrayReferenceGetDimensionsFcnPtr>(
  ...
  {
    size_t retVal;
    typedef int (*ArrayReferenceGetNumElementsFcnPtr)(detail::ReferenceImpl *,
                                                      size_t *);
    static const ArrayReferenceGetNumElementsFcnPtr fcn =
        detail::resolveFunction<ArrayReferenceGetNumElementsFcnPtr>(
  ...
  bool isEmpty() const
  {
    ...
    static const ArrayReferenceIsEmptyFcnPtr fcn =
        detail::resolveFunction<ArrayReferenceIsEmptyFcnPtr>(
...
/**
 * The IndexableArrayRef class is a base class for Reference<Array> to enable
 * the reference to be further indexed.
 */
...
protected:
  ...
  IndexableArrayRef<is_const_ref> &
  operator=(IndexableArrayRef<is_const_ref> &&rhs) MW_NOEXCEPT
  {
  ...
  IndexableArrayRef<is_const_ref> &
  operator=(const IndexableArrayRef<is_const_ref> &rhs) MW_NOEXCEPT
  {
