...
public:
  ...
  MATLABFieldIdentifier(std::string str) MW_NOEXCEPT
  {
    ...
    static const FieldIdCreateFcnPtr fcn =
        detail::resolveFunction<FieldIdCreateFcnPtr>(
    ...
    pImpl = std::shared_ptr<detail::RefCounted>(
        fcn(str.c_str(), str.size()), [](detail::RefCounted *ptr) {
          ...
          static const FieldIdDestroyFcnPtr fcn2 =
              detail::resolveFunction<FieldIdDestroyFcnPtr>(
   ...
   * @return updated MATLABFieldIdentifier which is a shared copy of the
   * original MATLABFieldIdentifier
   * @throw none
   */
  ...
  {
    typedef bool (*FieldIdIsEqualFcnPtr)(detail::RefCounted *,
                                         detail::RefCounted *);
    static const FieldIdIsEqualFcnPtr fcn =
        detail::resolveFunction<FieldIdIsEqualFcnPtr>(
   ...
   * @return std::string - std::string representation of the
  ...
  operator std::string() const MW_NOEXCEPT
  {
    ...
    size_t len = 0;
    typedef detail::RefCounted *(*FieldIdGetStringFcnPtr)(
        detail::RefCounted *, const char **, size_t *);
    static const FieldIdGetStringFcnPtr fcn =
        detail::resolveFunction<FieldIdGetStringFcnPtr>(
