...
#endif
/*lint -esym(1923,MX_GPUARRAY_DEFINED) // MACRO input cannot be converted to
 * const variable in C*/
 ...
 */
#define EMLRT_VERSION_R2024B 0x2024B
#define EMLRT_VERSION_INFO EMLRT_VERSION_R2024B
...
typedef void (*EmlrtErrorFunction)(const char *aIdentifier,
                                   const CHAR16_T *aMessage, emlrtCTX aTLS);
...
typedef void (*EmlrtLockerFunction)(EmlrtLockeeFunction aLockee,
                                    emlrtConstCTX aTLS, void *aData);
#define emlrtCallLockeeFunction(emlrtLockeeFcnPtr, emlrtLockeeArg0,            \
                                emlrtLockeeArg1)                               \
...
EXTERN_C LIBEMLRT_API mxArray *
emlrtAllocateClassEntryPointMx(emlrtCTX aTLS, uint32_T aClassIndex);

EXTERN_C LIBEMLRT_API void *
emlrtExtractClassEntryPointInstance(emlrtCTX aTLS, uint32_T aClassIndex,
                                    const mxArray *aClassMx);

EXTERN_C LIBEMLRT_API boolean_T emlrtIsCoderlibClassEntryPoint(
    emlrtCTX aTLS, uint32_T aClassIndex, const mxArray *aClassMx);
 ...
 * MATLAB INTERNAL USE ONLY :: Dispatch to mexPrintf
 */
EXTERN_C LIBEMLRT_API int32_T emlrtMexPrintf(emlrtConstCTX aTLS,
                                             const char *aFmt, ...);

/*
 * MATLAB INTERNAL USE ONLY :: Dispatch to snprintf
 */
EXTERN_C LIBEMLRT_API int32_T emlrtMexSnprintf(char *retString, size_t n,
                                               const char *aFmt, ...);
...
/*
 * MATLAB INTERNAL USE ONLY :: Protect mxArray from being overwritten if
 * necessary
 */
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtAssignP(const mxArray **lhs,
                                        const mxArray *rhs);
 ...
 */
EXTERN_C LIBEMLRT_API int64_T
emlrtBoundsCheckInt64(const int64_T indexValue, const emlrtBCInfo *const aInfo,
                      const emlrtCTX aTLS);
#endif
 ...
 */
EXTERN_C LIBEMLRT_API int32_T emlrtDynamicBoundsCheckR2012b(
    int32_T indexValue, int32_T loBound, int32_T hiBound,
    const emlrtBCInfo *aInfo, emlrtConstCTX aTLS);

#ifdef INT_TYPE_64_IS_SUPPORTED
/*
 * MATLAB INTERNAL USE ONLY :: Dynamic array bounds check for int64
 */
EXTERN_C LIBEMLRT_API int64_T emlrtDynamicBoundsCheckInt64(
    const int64_T indexValue, const int32_T loBound, const int32_T hiBound,
    const emlrtBCInfo *const aInfo, const emlrtConstCTX aTLS);
#endif

/*
 * MATLAB INTERNAL USE ONLY :: Check that the target value is within the design
 * range.
 */
...
/*
 * MATLAB INTERNAL USE ONLY :: Perform integer multiplication, raise runtime
 * error if the operation overflows.
 */
EXTERN_C LIBEMLRT_API size_t emlrtSizeMulR2012b(size_t s1, size_t s2,
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateStringR2022a(emlrtConstCTX aTLS,
                                                             const char *in);

/*
 * MATLAB INTERNAL USE ONLY :: Create an mxArray string from a single char
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateString1R2022a(emlrtConstCTX aTLS, char c);

/*
 * MATLAB INTERNAL USE ONLY :: Create a struct matrix mxArray
 */
EXTERN_C LIBEMLRT_API mxArray *
emlrtCreateStructMatrix(int32_T m, int32_T n, int32_T nfields,
 ...
 */
EXTERN_C LIBEMLRT_API mxArray *
emlrtCreateClassInstance2022a(emlrtConstCTX, const char *className);

/*
 * MATLAB INTERNAL USE ONLY :: Create a struct matrix mxArray
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateStructArray(int32_T ndim, const int32_T *pdim, int32_T nfields,
                       const char **field_names);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateField(const mxArray *mxStruct,
                                                      const char *fldName);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckSparse(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId,
                 const mxArray *s, const void *pDims, const boolean_T *aDynamic,
                 int32_T aClassId, int32_T aComplexity);
...
EXTERN_C LIBEMLRT_API boolean_T emlrtCompareString(const char *actual,
                                                   const char *expected);
...
EXTERN_C LIBEMLRT_API mxArray *emlrtGetCellElement(const mxArray *pa,
                                                   int index);

EXTERN_C LIBEMLRT_API int emlrtGetNumStructFields(const mxArray *pa);

EXTERN_C LIBEMLRT_API const char *emlrtGetStructFieldName(const mxArray *pa,
                                                          int index);

EXTERN_C LIBEMLRT_API mxArray *emlrtGetStructField(const mxArray *pa,
                                                   const char *fieldName);

EXTERN_C LIBEMLRT_API boolean_T
emlrtIsCompatibleSize(const mxArray *pa, const uint32_T *aSizeVec,
                      const boolean_T *aVardimVec, const uint32_T sizeLength);
...
EXTERN_C LIBEMLRT_API mxArray *emlrtGetClassProperty(const mxArray *pa,
...
EXTERN_C LIBEMLRT_API mxArray *
emlrtCreateSparse(const void *d, const int32_T *colidx, const int32_T *rowidx,
                  int32_T m, int32_T n, int32_T maxnz, int32_T aClassId,
                  int32_T aComplexity);
...
/*
 * MATLAB INTERNAL USE ONLY :: Set the value from propValues of all properties
 * in propNames of a class instance mxArray.
 */
EXTERN_C LIBEMLRT_API void emlrtSetAllProperties(
    emlrtConstCTX, const mxArray *const *, int32_T index,
    int32_T numberOfProperties, const char *const *propertyNames,
    const char *const *classNames, const mxArray *const *propertyValues);

/*
 * MATLAB INTERNAL USE ONLY :: Get the value mxArray of all properties of a
 * class instance mxArray.
 */
EXTERN_C LIBEMLRT_API void emlrtGetAllProperties(
    emlrtConstCTX, const mxArray *, int32_T index, int32_T numberOfProperties,
    const char *const *propertyNames, const char *const *classNames,
    const mxArray **propertyValues);

/*
 * MATLAB INTERNAL USE ONLY :: Get the redirect target MCOS instance mxArray of
 * a redirect source MCOS instance mxArray.
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtConvertInstanceToRedirectTarget(emlrtConstCTX aTLS, const mxArray *mxCls,
                                     int aIndex, const char *className);

/*
 * MATLAB INTERNAL USE ONLY :: Get the redirect source MCOS instance mxArray of
 * a redirect target MCOS instance mxArray.
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtConvertInstanceToRedirectSource(emlrtConstCTX aTLS, const mxArray *mxCls,
                                     int aIndex, const char *className);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtGetFieldR2017b(emlrtConstCTX aTLS, const mxArray *mxStruct, int32_T aIndex,
                    int32_T fldNumber, const char *fldName);

/*
 * MATLAB INTERNAL USE ONLY :: Set field value in structure array, given index
 * and field name
 */
EXTERN_C LIBEMLRT_API void emlrtSetField(mxArray *mxStruct, int32_T aIndex,
                                         const char *fldName, mxArray *mxValue);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateCellArrayR2014a(int32_T ndim, const int32_T *pdim);

/*
 * MATLAB INTERNAL USE ONLY :: Create a cell matrix mxArray
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateCellMatrix(int32_T m,
                                                           int32_T n);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtSetCell(const mxArray *mxCellArray, int32_T aIndex, const mxArray *mxCell);

/*
 * MATLAB INTERNAL USE ONLY :: Get a cell element
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtGetCell(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId,
             const mxArray *mxCell, int32_T aIndex);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateNumericMatrix(int32_T m, int32_T n, int32_T classID,
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateNumericArray(int32_T ndim, const void *pdim, int32_T classID,
                        int32_T nComplexFlag);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateScaledNumericArrayR2008b(int32_T ndim, const void *pdim,
                                    int32_T classID, int32_T nComplexFlag,
                                    int32_T aScale);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateCharArray(int32_T ndim,
                                                          const int32_T *dims);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCreateFIR2013b(emlrtConstCTX aTLS, const mxArray *fimath,
                    const mxArray *ntype, const char *fitype,
                    const mxArray *fival, const boolean_T fmIsLocal,
                    const boolean_T aForceComplex);

/*
 * MATLAB INTERNAL USE ONLY :: Set the dimensions of an mxArray.
 */
EXTERN_C LIBEMLRT_API int32_T emlrtSetDimensions(mxArray *aMx,
                                                 const int32_T *dims,
                                                 int32_T ndims);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtImportFiIntArrayR2008b(const mxArray *aFiMx);

/*
 * MATLAB INTERNAL USE ONLY :: Get the enum int32_T from an MCOS enumeration
 * mxArray.
 */
EXTERN_C LIBEMLRT_API int32_T emlrtGetEnumElementR2009a(const mxArray *aEnum,
                                                        int32_T aIndex);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtGetEnumUnderlyingArrayR2009a(const mxArray *aEnum);

/*
 * MATLAB INTERNAL USE ONLY :: Convert MATLAB mxArray data format to C data
 * format
 */
...
/*
 * MATLAB INTERNAL USE ONLY :: Try to coerce mxArray to provided class; return
 * same mxArray if not possible.
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCoerceToClassR2014b(const mxArray *inputMx, const char *className);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtDestroyArrays(int32_T narrays,
                                              const mxArray **parrays);

/*
 * MATLAB INTERNAL USE ONLY :: Free the imaginary part of a matrix if all the
 * imaginary elements are zero
 */
 ...
 */
EXTERN_C LIBEMLRT_API real_T emlrtNonNegativeCheckR2012b(
    real_T d, const emlrtDCInfo *aInfo, emlrtConstCTX aTLS);

/*
 * MATLAB INTERNAL USE ONLY :: Check that the loop range is valid for code
 * generation.
 */
EXTERN_C LIBEMLRT_API void
emlrtForLoopVectorCheckR2021a(real_T start, real_T step, real_T end,
                              mxClassID classID, int32_T n,
                              const emlrtRTEInfo *aInfo, emlrtConstCTX aTLS);

/*
 * MATLAB INTERNAL USE ONLY :: fetch a global variable
 */
EXTERN_C LIBEMLRT_API void emlrtPutGlobalVariable(const char *name,
...
/*
 * MATLAB INTERNAL USE ONLY :: Call out to MATLAB to report error from
 * MLFB/Stateflow
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtSFCallMATLABReportError(emlrtConstCTX aTLS, const emlrtMCInfo *aLoc,
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrtCallMATLABR2012b(emlrtConstCTX aTLS, int32_T nlhs, const mxArray **plhs,
                      int32_T nrhs, const mxArray **prhs, const char *cmd,
                      boolean_T tmp, const emlrtMCInfo *aLoc);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtHeapReferenceStackEnterFcnR2012b(emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtHeapReferenceStackLeaveScope(emlrtConstCTX aTLS, int32_T aAllocCount);

/*
 * MATLAB INTERNAL USE ONLY :: Leave a function within a MEX call.
 */
EXTERN_C LIBEMLRT_API void
emlrtHeapReferenceStackLeaveFcnR2012b(emlrtConstCTX aTLS);
...
EXTERN_C LIBEMLRT_API void emlrtPushHeapReferenceStackR2021a(
    emlrtConstCTX aTLS, bool aNeedStack, void *aHeapReference, void *aFreeFcn,
    void *aSimStruct, void *aJITInstance, void *aStackData);

/*
 * MATLAB INTERNAL USE ONLY :: Push emxArray onto heap reference stack.
 */
EXTERN_C LIBEMLRT_API void emlrtPushHeapReferenceStackEmxArray(
    emlrtConstCTX aTLS, bool aNeedStack, void *aHeapReference, void *aFreeFcn,
    void *aSimStruct, void *aJITInstance, void *aStackData);

EXTERN_C LIBEMLRT_API void emlrtRemoveHeapReference(emlrtConstCTX aTLS,
                                                    void *aHeapReference);

/*
 * MATLAB INTERNAL USE ONLY :: Push a new entry to the heap reference stack.
 */
EXTERN_C LIBEMLRT_API void emlrtSetGlobalSyncFcn(emlrtConstCTX aTLS,
                                                 void *aSyncFcn);
...
EXTERN_C LIBEMLRT_API void emlrtInitCharArrayR2013a(emlrtConstCTX aTLS,
                                                    int32_T n, const mxArray *a,
                                                    const char *s);

/*
 * MATLAB INTERNAL USE ONLY :: Initialize a logical mxArray
 */
EXTERN_C LIBEMLRT_API void emlrtInitLogicalArray(int32_T n, const mxArray *a,
                                                 const boolean_T *b);

/*
 * MATLAB INTERNAL USE ONLY :: Initialize an integral array from a multiword
 * type
 */
EXTERN_C LIBEMLRT_API void
emlrtInitIntegerArrayFromMultiword(const mxArray *aOut, const void *aInData);
 ...
 */
EXTERN_C LIBEMLRT_API int32_T emlrtGetEntryPointIndexR2016a(
    emlrtConstCTX aTLS, int32_T nrhs, const mxArray *prhs[],
    const char *aEntryPointNames[], int32_T aNumEntryPoints);

/*
 * MATLAB INTERNAL USE ONLY :: Decode wide character strings in mxArray struct
 * array. The struct array consists of name resolution entries which may contain
 * file paths. If the file path is using UTF-8, then the string is plain 7-bit
 * ASCII but encoded. We need to decode those if necessary. The resulting
 * mxArray strings (for file paths) will be proper UTF-16 strings.
 */
EXTERN_C LIBEMLRT_API void
emlrtNameCapturePostProcessR2013b(const mxArray **mxInfo);

/*
 * MATLAB INTERNAL USE ONLY :: Decode string array into mxArray object
 * containing name resolution data.
 */
EXTERN_C LIBEMLRT_API void
emlrtNameCaptureMxArrayR2016a(const char *mxInfoEncoded[],
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtEnterParallelRegion(emlrtConstCTX aTLS, boolean_T aInParallelRegion);

/*
 * MATLAB INTERNAL USE ONLY :: Exit a parallel region.
 */
EXTERN_C LIBEMLRT_API void emlrtExitParallelRegion(emlrtConstCTX aTLS,
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtAssertMATLABThread(emlrtConstCTX aTLS,
                                                   const emlrtMCInfo *aLoc);

/*
 * MATLAB INTERNAL USE ONLY :: Push the current jmp_buf environment
 */
EXTERN_C LIBEMLRT_API void emlrtPushJmpBuf(emlrtConstCTX aTLS,
                                           jmp_buf *volatile *aJBEnviron);

/*
 * MATLAB INTERNAL USE ONLY :: Pop the current jmp_buf environment
 */
EXTERN_C LIBEMLRT_API void emlrtPopJmpBuf(emlrtConstCTX aTLS,
                                          jmp_buf *volatile *aJBEnviron);

/*
 * MATLAB INTERNAL USE ONLY :: Set the current jmp_buf environment
 */
EXTERN_C LIBEMLRT_API void emlrtSetJmpBuf(emlrtConstCTX aTLS,
                                          jmp_buf *aJBEnviron);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtDivisionByZeroErrorR2012b(const emlrtRTEInfo *aInfo, emlrtConstCTX aTLS);

EXTERN_C LIBEMLRT_API void
emlrtDivisionByZeroWarningOrError2018b(const emlrtRTEInfo *aInfo,
                                       emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtIntegerOverflowErrorR2012b(const emlrtRTEInfo *aInfo, emlrtConstCTX aTLS);

EXTERN_C LIBEMLRT_API void
emlrtIntegerOverflowWarningOrError2018b(const emlrtRTEInfo *aInfo,
                                        emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtHeapAllocationErrorR2012b(const emlrtRTEInfo *aInfo, emlrtConstCTX aTLS);

/*
 * MATLAB INTERNAL USE ONLY :: Error with given message ID and args.
 */
EXTERN_C LIBEMLRT_API void
emlrtErrorWithMessageIdR2018a(emlrtConstCTX aTLS, const emlrtRTEInfo *aInfo,
                              const char *aMsgID, const char *aReportID,
                              int aArgCount, ...);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtErrorWithMessageIdR2012b(emlrtConstCTX aTLS, const emlrtRTEInfo *aInfo,
                              const char *aMsgID, int32_T aArgCount, ...);

/*
 * MATLAB INTERNAL USE ONLY :: Error with given message ID and args.
 */
EXTERN_C LIBEMLRT_API void
emlrtErrMsgIdAndTxt(emlrtCTX aTLS, const char *aMsgID, int32_T aArgCount, ...);

/*
 * MATLAB INTERNAL USE ONLY :: Error with given message ID and explicit message
 * text.
 */
EXTERN_C LIBEMLRT_API void
emlrtErrMsgIdAndExplicitTxt(emlrtConstCTX aTLS, const emlrtRTEInfo *aInfo,
                            const char *aMsgID, int32_T aStrlen,
                            const char *aMsgTxt);
 ...
 */
EXTERN_C LIBEMLRT_API mxArray *
emlrtLocationLoggingPullLog(const char *const MexFileName,
...
EXTERN_C LIBEMLRT_API void emlrtLocationLoggingPushLog(
    ...
    const uint8_T *serializedReport, size_t sizeofSerializedReport,
    const int32_T *numFieldsTables, const char **fieldNamesTables);
...
EXTERN_C LIBEMLRT_API void emlrtLocationLoggingPushLogR2017a(
    ...
    const emlrtLocationLoggingLocationType *const locationTables,
    const int32_T *numFieldsTables, const char **fieldNamesTables,
    const char *serializedReport[], size_t sizeofSerializedReport);

/*
 * MATLAB INTERNAL USE ONLY :: Clear LocationLogging Info
 */
EXTERN_C LIBEMLRT_API boolean_T
emlrtLocationLoggingClearLog(const char *const MexFileName);
 ...
 */
EXTERN_C LIBEMLRT_API const volatile char *
emlrtGetBreakCheckFlagAddressR2022b(emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtSizeEqCheck1DR2012b(int32_T dim1, int32_T dim2,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtSizeEqCheckNDErrorR2021b(const int32_T *dims1, const int32_T *dims2,
                              const emlrtECInfo *aInfo, emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtDimSizeEqCheckR2012b(int32_T dim1, int32_T dim2,
                                                     const emlrtECInfo *aInfo,
                                                     emlrtConstCTX aTLS);
...
EXTERN_C LIBEMLRT_API void emlrtDimSizeImpxCheckR2021b(int32_T dim1,
                                                       ...
                                                       emlrtConstCTX aTLS);
/*
 * MATLAB INTERNAL USE ONLY :: Check size compatibility for A(I1,..IN) = B
 * assignment in MATLAB.
 */
EXTERN_C LIBEMLRT_API void
emlrtSubAssignSizeCheckR2012b(const int32_T *dims1, int32_T nDims1,
                              const int32_T *dims2, int32_T nDims2,
                              const emlrtECInfo *aInfo, emlrtConstCTX aTLS);

/*
 * MATLAB INTERNAL USE ONLY :: Check size compatibility for A(I) = B assignment
 * in MATLAB.
 */
EXTERN_C LIBEMLRT_API void
emlrtSubAssignSizeCheck1dR2017a(int32_T dim1, int32_T dim2,
                                const emlrtECInfo *aInfo, emlrtConstCTX aTLS);

/*
 * MATLAB INTERNAL USE ONLY :: Allocate thread-local storage.
 */
EXTERN_C LIBEMLRT_API void *emlrtAllocTLS(emlrtConstCTX aMaster,
                                          int32_T aTeamTID);

/*
 * MATLAB INTERNAL USE ONLY :: Allocate thread local storage for a parallel
 * region.
 */
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtUpdateCTX(emlrtConstCTX emlrtCtx,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCreateRootTLSR2022a(emlrtCTX *aRootTLS, struct emlrtContext *aContext,
                         EmlrtLockerFunction aLockerFunction, int32_T aNumProcs,
                         void *aExceptionBridge, const char *aCharacterEncoding,
...
EXTERN_C LIBEMLRT_API void emlrtShouldCleanupOnError(emlrtCTX aTLS,
                                                     bool aValue);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtSetSimThruJIT(emlrtCTX aTLS,
                                              boolean_T aSimThruJIT);

EXTERN_C LIBEMLRT_API char *
emlrtExtractMessageId2015b(emlrtConstCTX aTLS,
...
/*
 * MATLAB INTERNAL USE ONLY :: Check the class of an mxArray pa to be exactly
 * aClassName, otherwise error out using aMsgId and aTLS.
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckMcosClass2017a(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId,
                         const mxArray *pa, const char *aClassName);
/*
 * MATLAB INTERNAL USE ONLY :: Check the contents of two mxArrays to be equal.
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckCtMxArray2018b(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId,
                         const mxArray *rtArray, const mxArray *ctArray);

/*
 * MATLAB INTERNAL USE ONLY :: Check the size, class and complexness of an
 * mxArray
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckBuiltInR2012b(emlrtConstCTX aTLS,
                        const struct emlrtMsgIdentifier *aMsgId,
                        const mxArray *pa, const char *className,
                        boolean_T complex, uint32_T nDims, const void *pDims);

/*
 * MATLAB INTERNAL USE ONLY :: Check the size, class and complexness of a
 * variable-size mxArray
 */
EXTERN_C LIBEMLRT_API void emlrtCheckVsBuiltInR2012b(
    emlrtConstCTX aTLS, const struct emlrtMsgIdentifier *aMsgId,
    const mxArray *pa, const char *className, boolean_T complex, uint32_T nDims,
    const void *pDims, const boolean_T *aDynamic, int32_T *aOutSizes);

/*
 * MATLAB INTERNAL USE ONLY :: Check the type of a FI mxArray
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckFiR2012b(emlrtConstCTX aTLS, const struct emlrtMsgIdentifier *aMsgId,
                   const mxArray *aFi, boolean_T aComplex, uint32_T aNDims,
                   const void *aVDims, const mxArray *aFimath,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckVsFiR2012b(emlrtConstCTX aTLS,
                     const struct emlrtMsgIdentifier *aMsgId,
                     const mxArray *aFi, boolean_T aComplex, uint32_T aNDims,
                     const void *aVDims, const boolean_T *aDynamic,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckStructR2012b(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId,
                       const mxArray *s, int32_T nFields,
                       const char *const *fldNames, uint32_T nDims,
                       const void *pDims);

/*
 * MATLAB INTERNAL USE ONLY :: Check the type of a variable-size struct mxArray
 */
EXTERN_C LIBEMLRT_API void emlrtCheckVsStructR2012b(
    emlrtConstCTX aTLS, const struct emlrtMsgIdentifier *aMsgId,
    const mxArray *s, int32_T nFields, const char *const *fldNames,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckArrayChecksumR2018b(emlrtConstCTX, mxArray const *,
                              boolean_T globalVar, int const *,
                              const char *const *, uint32_T const *);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtImportCharR2015b(emlrtConstCTX aTLS, const mxArray *aSrc, char_T *aDst);

/*
 * MATLAB INTERNAL USE ONLY :: Import an mxArray
 */
EXTERN_C LIBEMLRT_API void
emlrtImportArrayR2015b(emlrtConstCTX aTLS, const mxArray *aIn, void *aOutData,
                       int32_T aElementSize, boolean_T aComplex);

/*
 * MATLAB INTERNAL USE ONLY :: Import an mxArray
 */
EXTERN_C LIBEMLRT_API void
emlrtImportArrayR2015b_SameComplex(emlrtConstCTX aTLS, const mxArray *aIn,
                                   void *aOutData, int32_T aElementSize);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtSetVsFiSizesR2024a(emlrtConstCTX aTLS, const mxArray *aFi, uint32_T aNDims,
                        const int32_T *aVDims, const boolean_T *aDynamic,
                        int32_T *aOutSizes);

/*
 * MATLAB INTERNAL USE ONLY :: Get double uniform random values in (0,1)
 */
EXTERN_C LIBEMLRT_API void emlrtRandu(real_T *const aRanduBuffer,
                                      const int32_T aNumel);

/*
 * MATLAB INTERNAL USE ONLY :: Get double normal random values
 */
EXTERN_C LIBEMLRT_API void emlrtRandn(real_T *const aRandnBuffer,
                                      const int32_T aNumel);
...
EXTERN_C LIBEMLRT_API void emlrtCheckCell(emlrtConstCTX aTLS,
                                          ...
                                          const mxArray *s, uint32_T nDims,
                                          const void *pDims,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckVsCell(emlrtConstCTX aTLS, const struct emlrtMsgIdentifier *aMsgId,
                 const mxArray *s, uint32_T nDims, const void *pDims,
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtCheckCellWithUnassignedBase(emlrtConstCTX aTLS,
                                 const struct emlrtMsgIdentifier *aMsgId,
                                 const mxArray *pa);
...
/*
 * MATLAB INTERNAL USE ONLY :: Double 1D complex to complex FFT, this function
 * assumes in and out to be interleaved complex.
 */
EXTERN_C LIBEMLRT_API void emlrtFFTW_1D_C2C(const real_T *in, real_T *out,
                                            int32_T stride, int32_T fftLen,
                                            int32_T ldx, int32_T numFFT,
                                            int32_T direction);

EXTERN_C LIBEMLRT_API void emlrtFFTW_1D_R2C(const real_T *in, real_T *out,
                                            int32_T stride, int32_T fftLen,
                                            int32_T ldx, int32_T numFFT,
                                            int32_T direction);

EXTERN_C LIBEMLRT_API void emlrtFFTW_1D_C2R(const real_T *in, real_T *out,
                                            int32_T stride, int32_T fftLen,
                                            int32_T ldx, int32_T numFFT,
                                            int32_T direction);

/*
 * MATLAB INTERNAL USE ONLY :: Float 1D complex to complex FFT, this function
 * assumes in and out to be interleaved complex.
 */
EXTERN_C LIBEMLRT_API void emlrtFFTWF_1D_C2C(const real32_T *in, real32_T *out,
                                             int32_T stride, int32_T fftLen,
                                             int32_T ldx, int32_T numFFT,
                                             int32_T direction);

EXTERN_C LIBEMLRT_API void emlrtFFTWF_1D_R2C(const real32_T *in, real32_T *out,
                                             int32_T stride, int32_T fftLen,
                                             int32_T ldx, int32_T numFFT,
                                             int32_T direction);

EXTERN_C LIBEMLRT_API void emlrtFFTWF_1D_C2R(const real32_T *in, real32_T *out,
                                             int32_T stride, int32_T fftLen,
                                             int32_T ldx, int32_T numFFT,
                                             int32_T direction);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtMEXProfilingFunctionEntry(const char *fcnUniqKey, boolean_T isMexOutdated);

/*
 * MATLAB INTERNAL USE ONLY :: MEX Profiling Function Exit
 */
EXTERN_C LIBEMLRT_API void
emlrtMEXProfilingFunctionExit(boolean_T isMexOutdated);

#else
// Need a sentinel class to make sure call stack is correct during stack
// unwinding
 ...
 */
LIBEMLRT_API void
emlrtMEXProfilingFunctionEntryCPP(const char *fcnUniqKey,
 ...
 */
LIBEMLRT_API void
emlrtMEXProfilingFunctionExitCPP(emlrtProfilerSentinel *aSentinel);
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtProfilerUnregisterMEXFcn(const char *fcnUniqKey, boolean_T isMexOutdated);

/*
 * MATLAB INTERNAL USE ONLY :: MEX Profiling Register Function
 */
EXTERN_C LIBEMLRT_API void
emlrtProfilerRegisterMEXFcn(const char *completeName, const char *aPath,
                            const char *aFcnName, int32_T numLineNos,
                            const int32_T *lineNos, boolean_T isMexOutdated);

/*
 * MATLAB INTERNAL USE ONLY :: MEX Profiling Profile Statement
 */
EXTERN_C LIBEMLRT_API void emlrtMEXProfilingStatement(uint32_T aPoint,
                                                      boolean_T isMexOutdated);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtCUDAError(uint32_T errcode, const char *ename,
                                          const char *emsg,
                                          const emlrtRTEInfo *aInfo,
                                          emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtOpenCLError(int32_T errcode, const char *ename,
                                            const char *emsg,
                                            const emlrtRTEInfo *aInfo,
                                            emlrtConstCTX aTLS);
 ...
 * useful for capturing errors within destructors and throwing those as
 * warnings, so that MATLAB does not crash for MEX builds
 */
EXTERN_C LIBEMLRT_API void emlrtCUDAWarning(uint32_T errcode, const char *ename,
                                            const char *emsg,
                                            const emlrtRTEInfo *aInfo);
/*
 ...
 */
EXTERN_C LIBEMLRT_API void
emlrtThinCUDAError(uint32_T errcode, const char *ename, const char *emsg,
                   const char *paramname, emlrtConstCTX aTLS);
...
EXTERN_C LIBEMLRT_API mxArray *
emlrtMxCreateRowVectorUINT8(const uint8_T *aArray, uint32_T aSize);
...
EXTERN_C LIBEMLRT_API const mxArray *
emlrtMexGetVariablePtr(const char *workspace, const char *varname);
/*
 ...
 */
EXTERN_C LIBEMLRT_API int32_T emlrtEncoding2Encoding(
    const char *aSrcEncoding, const char *aDstEncoding,
    int32_T aSizeConsistencyEnabled, int32_T aInputBufferLength,
    const char *aInputBuffer, char *aOutputBuffer);

EXTERN_C LIBEMLRT_API void emlrtCaptureInputs(const mxArray *const *data,
                                              int32_T numInputs, void *aFcnPtr);

/*
 * MATLAB INTERNAL USE ONLY :: Create a numeric matrix mxGPUArray
 */
EXTERN_C LIBEMLRT_API mxGPUArray *
emlrtGPUCreateNumericArray(const char *className, boolean_T nComplexFlag,
                           int32_T ndim, const void *pdim);

/*
 * MATLAB INTERNAL USE ONLY :: Get read only GPU device pointer from mxGpuArray
 */
EXTERN_C LIBEMLRT_API const void *
emlrtGPUGetDataReadOnly(const mxGPUArray *inArray);
 ...
 */
EXTERN_C LIBEMLRT_API const mxGPUArray *
emlrt_marshallInGPU(emlrtConstCTX aTLS, const mxArray *inArray, const char *id,
                    const char *className, boolean_T nComplexFlag, int32_T ndim,
                    const void *pdim, boolean_T marshallByRef);

/*
 * MATLAB INTERNAL USE ONLY :: Marshall input mxArray and return mxGPUArray
 */
EXTERN_C LIBEMLRT_API const mxGPUArray *
emlrt_marshallInGPUVardim(emlrtConstCTX aTLS, const mxArray *inArray,
                          const char *id, const char *className,
                          boolean_T nComplexFlag, int32_T ndim,
                          const void *pdim, boolean_T marshallByRef,
                          const boolean_T *aDynamic, int32_T *aOutSizes);
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrt_marshallOutGPU(const mxGPUArray *inArray);

/*
 * MATLAB INTERNAL USE ONLY :: Marshall output mxGPUArray and return mxArray
 */
EXTERN_C LIBEMLRT_API const mxArray *
emlrt_marshallOutGPUVardim(mxGPUArray *const inArray, const int32_T aNDims,
 ...
 */
EXTERN_C LIBEMLRT_API mxGPUArray *
emlrtGPUCopyGPUArray(const mxGPUArray *inArray);
...
EXTERN_C LIBEMLRT_API void
emlrtProfilingDMTypeDimension(uint64_T aTypeSequenceId, uint64_T aNodeId,
                              uint32_T aDimension, uint64_T aElementCount);
