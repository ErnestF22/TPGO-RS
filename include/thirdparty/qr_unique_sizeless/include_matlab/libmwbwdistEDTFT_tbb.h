...
/* uint32_T */
EXTERN_C LIBMWBWDISTEDTFT_TBB_API void bwdistEDTFT32_tbb_boolean(
    const boolean_T *bw,        /** Pointer to bw image */
    ...
    uint32_T
        *labels); /** Output - label, feature transform (linear index to nearest
                     non-zero pixel). Pass NULL to skip this computation. */
