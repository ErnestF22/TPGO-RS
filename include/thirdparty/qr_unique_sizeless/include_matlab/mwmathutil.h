...
/* [br, bi] = exp(ar, ai) */
EXTERN_C void muDoubleComplexScalarExp(double *pyr, double *pyi, double xr,
                                       double xi);

/* hypot(ar, ai) */
EXTERN_C double muDoubleComplexScalarHypot(double ar, double ai, double br,
                                           double bi);

/* [br, bi] = log(ar, ai) */
EXTERN_C void muDoubleComplexScalarLog(double *pyr, double *pyi, double xr,
                                       double xi);

/* [cr, ci] = power(ar, ai, br, bi) */
EXTERN_C void muDoubleComplexScalarPower(double *cr, double *ci, double ar,
                                         double ai, double br, double bi);

/* [br, bi] = sqrt(ar, ai) */
EXTERN_C void muDoubleComplexScalarSqrt(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = sign(ar, ai) */
EXTERN_C void muDoubleComplexScalarSign(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = sin(ar, ai) */
EXTERN_C void muDoubleComplexScalarSin(double *br, double *bi, double ar,
                                       double ai);

/* [br, bi] = cos(ar, ai) */
EXTERN_C void muDoubleComplexScalarCos(double *br, double *bi, double ar,
                                       double ai);
...
EXTERN_C void muDoubleComplexScalarSinCos(double *pySr, double *pySi,
                                          double *pyCr, double *pyCi, double xr,
                                          double xi);

/* [br, bi] = tan(ar, ai) */
EXTERN_C void muDoubleComplexScalarTan(double *br, double *bi, double ar,
                                       double ai);

/* [br, bi] = atan(ar, ai) */
EXTERN_C void muDoubleComplexScalarAtan(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = asin(ar, ai) */
EXTERN_C void muDoubleComplexScalarAsin(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = acos(ar, ai) */
EXTERN_C void muDoubleComplexScalarAcos(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = sinh(ar, ai) */
EXTERN_C void muDoubleComplexScalarSinh(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = cosh(ar, ai) */
EXTERN_C void muDoubleComplexScalarCosh(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = tanh(ar, ai) */
EXTERN_C void muDoubleComplexScalarTanh(double *br, double *bi, double ar,
                                        double ai);

/* [br, bi] = asinh(ar, ai) */
EXTERN_C void muDoubleComplexScalarAsinh(double *br, double *bi, double ar,
                                         double ai);

/* [br, bi] = acosh(ar, ai) */
EXTERN_C void muDoubleComplexScalarAcosh(double *br, double *bi, double ar,
                                         double ai);

/* y = complexmultiply(u1, u2) */
EXTERN_C void muDoubleComplexScalarMultiply(creal_T *y, const creal_T *u1,
                                            const creal_T *u2);
...
/* [br, bi] = exp(ar, ai) */
EXTERN_C void muSingleComplexScalarExp(float *pyr, float *pyi, float xr,
                                       float xi);

/* hypot(ar, ai) */
EXTERN_C float muSingleComplexScalarHypot(float ar, float ai, float br,
                                          float bi);

/* [br, bi] = log(ar, ai) */
EXTERN_C void muSingleComplexScalarLog(float *pyr, float *pyi, float xr,
                                       float xi);

/* [cr, ci] = power(ar, ai, br, bi) */
EXTERN_C void muSingleComplexScalarPower(float *cr, float *ci, float ar,
                                         float ai, float br, float bi);

/* [br, bi] = sqrt(ar, ai) */
EXTERN_C void muSingleComplexScalarSqrt(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = sign(ar, ai) */
EXTERN_C void muSingleComplexScalarSign(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = sin(ar, ai) */
EXTERN_C void muSingleComplexScalarSin(float *br, float *bi, float ar,
                                       float ai);

/* [br, bi] = cos(ar, ai) */
EXTERN_C void muSingleComplexScalarCos(float *br, float *bi, float ar,
                                       float ai);
...
/* [Sr, Si, Cr, Ci] = sincos(ar, ai) */
EXTERN_C void muSingleComplexScalarSinCos(float *pySr, float *pySi, float *pyCr,
                                          float *pyCi, float xr, float xi);

/* [br, bi] = tan(ar, ai) */
EXTERN_C void muSingleComplexScalarTan(float *br, float *bi, float ar,
                                       float ai);

/* [br, bi] = atan(ar, ai) */
EXTERN_C void muSingleComplexScalarAtan(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = asin(ar, ai) */
EXTERN_C void muSingleComplexScalarAsin(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = acos(ar, ai) */
EXTERN_C void muSingleComplexScalarAcos(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = sinh(ar, ai) */
EXTERN_C void muSingleComplexScalarSinh(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = cosh(ar, ai) */
EXTERN_C void muSingleComplexScalarCosh(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = tanh(ar, ai) */
EXTERN_C void muSingleComplexScalarTanh(float *br, float *bi, float ar,
                                        float ai);

/* [br, bi] = asinh(ar, ai) */
EXTERN_C void muSingleComplexScalarAsinh(float *br, float *bi, float ar,
                                         float ai);

/* [br, bi] = acosh(ar, ai) */
EXTERN_C void muSingleComplexScalarAcosh(float *br, float *bi, float ar,
                                         float ai);

/* y = complexmultiply(u1, u2) */
EXTERN_C void muSingleComplexScalarMultiply(creal32_T *y, const creal32_T *u1,
                                            const creal32_T *u2);
