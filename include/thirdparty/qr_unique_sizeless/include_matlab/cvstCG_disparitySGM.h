...
EXTERN_C LIBMWDISPARITYSGM_API void disparitySGMCompute(
    uint8_T *inImg1, uint8_T *inImg2, uint32_T *left_CT, uint32_T *right_CT,
    int16_T *MC_img, int16_T *minLr0Buf, int16_T *minLr1Buf, int16_T *Lr0Buf,
    int16_T *Lr1Buf, int16_T *_Lr0Buf, int16_T *Lr4Buf, int16_T *dirCost_sum,
    int nRows, int nCols, float *dis, cvstDisparitySGMStruct_T *params);
