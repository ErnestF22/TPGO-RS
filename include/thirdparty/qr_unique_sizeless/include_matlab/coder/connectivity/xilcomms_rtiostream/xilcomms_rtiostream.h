...
EXTERN_C LIBMWXILCOMMS_RTIOSTREAM_API boolean_T xilCommsCreate(
    void **const ppXILCommsRTIOStream, const void *const pRTIOStreamData,
    const void *const pSILDebuggingData, const int memUnitSizeBytes,
    const void *const pMemUnitXformer, void *const pXILUtils,
    const boolean_T isVerbose);

/* Destroy xilcomms service */
EXTERN_C LIBMWXILCOMMS_RTIOSTREAM_API void
xilCommsDestroy(void *const pXILCommsRTIOStream);

/* Receive data and dispatch to owning application */
EXTERN_C LIBMWXILCOMMS_RTIOSTREAM_API boolean_T
xilCommsRun(void *const pXILCommsRTIOStream, void *const pXILUtilsVoid);

/* Register an application with xilcomms */
EXTERN_C LIBMWXILCOMMS_RTIOSTREAM_API void
xilCommsRegisterApplication(void *const pXILCommsRTIOStream,
