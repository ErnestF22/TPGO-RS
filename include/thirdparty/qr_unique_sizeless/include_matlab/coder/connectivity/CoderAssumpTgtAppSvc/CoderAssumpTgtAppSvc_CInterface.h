...
CODERASSUMPTGTAPPSVC_API_EXTERN_C uint8_T
coderAssumpTgtAppSvcAllocBuffer(void **ppBuf, const uint16_T size);

CODERASSUMPTGTAPPSVC_API_EXTERN_C IOUnit_T *
coderAssumpTgtAppSvcGetBufferDataPtr(void *pBufVoid);

CODERASSUMPTGTAPPSVC_API_EXTERN_C uint8_T
coderAssumpTgtAppSvcSend(void *pBufVoid, const uint16_T payloadSize);

CODERASSUMPTGTAPPSVC_API_EXTERN_C uint16_T
coderAssumpTgtAppSvcGetMaxPayloadCapacity(void);
