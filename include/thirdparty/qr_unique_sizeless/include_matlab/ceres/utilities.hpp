...
template <typename VertexPose, typename ConstraintPose, typename VertexPoint,
          typename ConstraintPosePoint>
bool read_g2o(const std::string &fileName, std::vector<VertexPose> &vertices1,
