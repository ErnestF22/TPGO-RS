...
EXTERN_C void suSubstr(void *outstr, const void *instr, int32_T pos,
                       int32_T len);
...
EXTERN_C void suWriteSILStringInput(char *sil_in, int32_T size,
                                    const void *src);
EXTERN_C void suWriteSILStringOutput(void *dst, const char *sil_out,
                                     int32_T size);
...
EXTERN_C void suReplaceBetweenIdxInclusive(void *outstr, const void *str,
                                           int32_T left, int32_T right,
                                           const void *newStr);
EXTERN_C void suReplaceBetweenIdxExclusive(void *outstr, const void *str,
                                           int32_T left, int32_T right,
                                           const void *newStr);
EXTERN_C void suReplaceBetweenSubstrExclusive(void *outstr, const void *str,
                                              const void *startStr,
                                              const void *endStr,
                                              const void *newStr);
EXTERN_C void suReplaceBetweenSubstrInclusive(void *outstr, const void *str,
                                              const void *startStr,
                                              const void *endStr,
                                              const void *newStr);
