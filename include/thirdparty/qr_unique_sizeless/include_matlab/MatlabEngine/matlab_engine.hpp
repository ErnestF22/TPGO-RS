...
public:
   ...
   * @throw MATLABExecutionException
   */
  void setProperty(matlab::data::Array &objectArray, size_t index,
                   const std::u16string &propertyName,
                   const matlab::data::Array &property);
   ...
   * @param error - The stream used to redirect standard error generated by
   * MATLAB
   * @return FutureResult<void> - A future to the evaluate of the MATLAB
   * statement
   *
   * @throw none
   */
   ...
   * @param varName - The name of a MATLAB variable in the base or global
   * workspace
   * @return FutureResult<matlab::data::Array> - A future to get the variable
   ...
   * @param object - A scalar object
   * @param propertyName - The name of the property to get for the object
   * @return FutureResult<matlab::data::Array> - A future to get the property
   * from the object
   *
   * @throw none
   */
   ...
   */
  FutureResult<matlab::data::Array>
  getPropertyAsync(const matlab::data::Array &objectArray, size_t index,
                   const std::u16string &propertyName);
