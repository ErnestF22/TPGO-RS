 ...
 * matlab::engine::startMATLABAsync and matlab::engine::connectMATLABAsync
 * return instances of this type.
 */
template <>
class FutureResult<std::unique_ptr<MATLABEngine>>
    : public std::future<std::unique_ptr<MATLABEngine>> {
public:
  /**
   ...
   */
  FutureResult(
      FutureResult<std::unique_ptr<MATLABEngine>> &&a_futureresult) noexcept;
  ...
  operator=(FutureResult<std::unique_ptr<MATLABEngine>> &&rhs) noexcept;
 ...
 * FutureResult<std::unique_ptr<MATLABEngine>>.shared()
 */
template <>
class SharedFutureResult<std::unique_ptr<MATLABEngine>>
    : public std::shared_future<std::unique_ptr<MATLABEngine>> {
public:
  SharedFutureResult();
   ...
   * @throw none
   */
  SharedFutureResult<std::unique_ptr<MATLABEngine>> &
  operator=(SharedFutureResult<std::unique_ptr<MATLABEngine>> &&rhs) noexcept;
   ...
   */
  SharedFutureResult<std::unique_ptr<MATLABEngine>> &
  operator=(const SharedFutureResult<std::unique_ptr<MATLABEngine>> &rhs);
