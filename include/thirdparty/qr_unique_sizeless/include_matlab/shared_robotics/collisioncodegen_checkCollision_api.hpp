...
/**
 * @file
 * @brief This file defines the exported APIs of the collisioncodegen (kernel
 ...
 * @param isColumnMajor The boolean indicating if vertices are input in column
 * major format
...
intersect(const void *obj1, const void *obj2, int computeDistance,
          ccd_real_t *p1Vec, ccd_real_t *p2Vec, ccd_real_t &distance);

/**
 * @brief Updates the pose of the geometry with the given position and
 * orientation
