...
EXTERN_C COLLISIONCODEGEN_API int8_T collisioncodegen_intersect2(
    CollisionGeometryStruct *obj1, const real64_T *vert1,
    CollisionGeometryStruct *obj2, const real64_T *vert2,
    real64_T computeDistance, real64_T *p1Vec, real64_T *p2Vec,
    real64_T *distance);
