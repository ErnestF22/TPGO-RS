 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API void astarcore_setStart(void *astarObj,
 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API void astarcore_setGoal(void *astarObj,
                                                      const uint32_T goal);
 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API uint32_T
astarcore_getCurrentNode(void *astarObj);
 ...
 * @param[in] transitionCosts Transition costs between current nodeID and the
 * neighbor nodeIDs
 * @param[in] heuristicCosts Heuristic costs between neighbor IDs and goal
 */
EXTERN_C ASTARCORE_CODEGEN_API void astarcore_loopThroughNeighbors(
    void *astarObj, const uint32_T nSize, const uint32_T *neighbors,
    const real64_T *transitionCosts, const real64_T *heuristicCosts);
 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API void astarcore_getPath(void *astarObj,
                                                      real64_T *path);
 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API void
astarcore_getExploredNodes(void *astarObj, real64_T *exploredNodes);
 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API uint32_T
astarcore_getNumExploredNodes(void *astarObj);
 ...
 */
EXTERN_C ASTARCORE_CODEGEN_API boolean_T
astarcore_stopCondition(void *astarObj);
