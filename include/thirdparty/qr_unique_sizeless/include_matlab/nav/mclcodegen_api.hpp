 ...
 */
EXTERN_C MCL_CODEGEN_API void
mclSetMotionModel_real64(void *mclObj, const real64_T *motionParams);
 ...
 * @param[in] originx X location for origin. The origin is the center of the
 * map.
 * @param[in] originy Y location for origin. The origin is the center of the
 * map.
 * @param[in] gridCells Occupancy grid data in row-major format 1D array.
 */
EXTERN_C MCL_CODEGEN_API void
mclSetOccupancyGrid_real64(void *mclObj, real64_T width, real64_T height,
                           real64_T resolution, real64_T originx,
                           real64_T originy, const real64_T *gridCells);
 ...
 * @param[in] sensorLimits Min and Max measurement limits of the range sensor,
 * [min max]
 * @param[in] sensorPoseParams Sensor location relative to robot base [x y yaw]
 */
EXTERN_C MCL_CODEGEN_API void mclSetSensorModel_real64(
    void *mclObj, real64_T max_beams, real64_T z_hit, real64_T z_rand,
    real64_T sigma_hit, real64_T laser_likelihood_max_dist,
    const real64_T *sensorLimits, const real64_T *sensorPoseParams);
 ...
 */
EXTERN_C MCL_CODEGEN_API void
mclInitializePf_real64(void *mclObj, real64_T minParticles,
                       real64_T maxParticles, real64_T alphaSlow,
                       real64_T alphaFast, real64_T kldErr, real64_T kldZ);
 ...
 * @param[in] covParams Initial covariance 9 element array in column major
 * format.
 */
EXTERN_C MCL_CODEGEN_API void
mclSetInitialPose_real64(void *mclObj, const real64_T *poseParams,
 ...
 * @param[in] mclObj MonteCarloLocalizationInternal object
 * @param[out] maxWeightHyp 12 elements of mean and covariance in row major
 * format
 */
EXTERN_C MCL_CODEGEN_API void mclGetHypothesis_real64(void *mclObj,
                                                      real64_T *maxWeightHyp);
 ...
 * @param[in] mclObj MonteCarloLocalizationInternal object
 * @param[out] particleInfo A vector representing [x, y, theta] states of
 * particles in column major format
 */
EXTERN_C MCL_CODEGEN_API void mclGetParticles_real64(void *mclObj,
                                                     real64_T *particleInfo);
 ...
 * @param[in] poseParams Odometry pose of the robot [x y theta].
 */
EXTERN_C MCL_CODEGEN_API void mclPredict_real64(void *mclObj,
                                                const real64_T *poseParams);
 ...
 */
EXTERN_C MCL_CODEGEN_API void
mclSetResamplingInterval_real64(void *mclObj, real64_T interval);
 ...
 */
EXTERN_C MCL_CODEGEN_API void mclSetTestHookForMemory_real64(void *mclObj,
                                                             boolean_T value);
