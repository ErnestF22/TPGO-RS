/**
 * @file dpgrid_codegen_util.hpp
 * @brief Utility functions for DPGrid functionality in codegen.
 */
...
#if defined(BUILDING_LIBMWDPGRIDCODEGEN)
/* For DLL_EXPORT_SYM and EXTERN_C */
#include "package.h"
/* For uint32_T, boolean_T, etc */
#include "tmwtypes.h"

#define DPGRID_CODEGEN_API DLL_EXPORT_SYM
...
#ifndef DPGRID_CODEGEN_API
#define DPGRID_CODEGEN_API
#endif
