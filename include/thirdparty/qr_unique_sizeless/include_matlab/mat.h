...
/*
 * Return zero if MATFile is successfully openedno error, nonzero value
 * otherwise.
 */
 ...
 */
EXTERN_C LIBMAT_API matError matPutVariable(MATFile *pMF, const char *name,
                                            const mxArray *pA);
 ...
 * Return zero for success, nonzero for error.
 */
EXTERN_C LIBMAT_API matError matPutVariableAsGlobal(MATFile *pMF,
                                                    const char *name,
                                                    const mxArray *pA);
 ...
 * Return NULL if an error occurs.
 */
EXTERN_C LIBMAT_API mxArray *matGetNextVariable(MATFile *pMF,
                                                const char **nameptr);
 ...
 * Return NULL if an error occurs.
 */
EXTERN_C LIBMAT_API mxArray *matGetNextVariableInfo(MATFile *pMF,
                                                    const char **nameptr);
