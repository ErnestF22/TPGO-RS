...
inline NamedHashFunction<uint16_t>::HashFunction
FindHashFunction16(const char *name)
{
...
inline NamedHashFunction<uint32_t>::HashFunction
FindHashFunction32(const char *name)
{
...
inline NamedHashFunction<uint64_t>::HashFunction
FindHashFunction64(const char *name)
{
