...
/* the numbers of rows are double because complexRopt numbers need double memory compared to realRopt numbers*/
    ...
    Vector &CFixedRankQ2F::ExtrProjection(const Variable &x, const Vector &etax, Vector *result) const
    {
        ...
        /*tmp1 = (H^T H)^{-1} (H^T Z)*/
        Vector tmp1(r, r, "complexRopt"); tmp1.AlphaABaddBetaThis(GLOBAL::ZONE, x.GetElement(1), GLOBAL::C, inetax.GetElement(1), GLOBAL::N, GLOBAL::ZZERO);
        tmp1 = tmp1.TriangleLinSol(LH, GLOBAL::N);
        tmp1 = tmp1.TriangleLinSol(LH, GLOBAL::C);
        
        /*tmp2 = (G^T G)^{-1} (G^T W)*/
        Vector tmp2(r, r, "complexRopt"); tmp2.AlphaABaddBetaThis(GLOBAL::ZONE, x.GetElement(0), GLOBAL::C, inetax.GetElement(0), GLOBAL::N, GLOBAL::ZZERO);
    ...
    realdp CFixedRankQ2F::Metric(const Variable &x, const Vector &etax, const Vector &xix) const
    {
        ...
        realdp result = 0;
        Vector tmp1(r, r, "complexRopt"); tmp1.AlphaABaddBetaThis(GLOBAL::ZONE, G, GLOBAL::C, G, GLOBAL::N, GLOBAL::ZZERO);
        Vector tmp2(r, r, "complexRopt"); tmp2.AlphaABaddBetaThis(GLOBAL::ZONE, xixH, GLOBAL::C, etaxH, GLOBAL::N, GLOBAL::ZZERO);
