...
namespace ROPTLIB
{
   ...
   class LsomProblem : public Problem
   {
   public:
      /**
       ...
       */
      LsomProblem(SomUtils::SomSize somSz, SomUtils::MatD &Tijs, Eigen::MatrixXi &edges);

      /**
       * Standard constructor with problem data inputs (most commonly used)
       */
      LsomProblem(const SomUtils::SomSize somSz, const SomUtils::MatD &Tijs, const Eigen::MatrixXi &edges);
      ...
      /**
       * LSOM ReLU argument function -> applies intended compensative function to lambdaE; this output will then undergo ReLU
       */
      double lsomReLUargument(double lambdaE) const;
      ...
      /**LSOM egradR (used inside hessian computation) */
      void lsomEgradR(const SomUtils::VecMatD &xR, const SomUtils::MatD &xT,
      ...
      /**
       * Output of lsom for R
       */
      SomUtils::VecMatD Rout_;

      /**
       * Output of lsom for T
       */
      SomUtils::MatD Tout_;
       ...
       */
      void lsomPimFunctionGenproc(const SomUtils::VecMatD &xR, const SomUtils::MatD &xT, const SomUtils::MatD &xLambdas,
       ...
       * Number of max iterations of PIM is set empirically to 2500
       */
      void lsomPimFunctionGenprocShifted(const SomUtils::VecMatD &xR, const SomUtils::MatD &xT, const SomUtils::MatD &xLambdas,
                                         const SomUtils::VecMatD &uR, const SomUtils::MatD &uT, const SomUtils::MatD &uLambdas,
                                         double mu,
                                         double &lambdaMax,
                                         SomUtils::VecMatD &uOutR, SomUtils::MatD &uOutT, SomUtils::MatD &uOutLambdas,
      ...
      /**
       * For debug purposes, reduced version of lsomPimHessianGenproc, up to linesearch (excluded)
       ...
       */
      void lsomPimHessianGenprocSmall(double thresh, const SomUtils::VecMatD &R, const SomUtils::MatD &T) const;
       ...
       */
      void lsomPimHessianGenprocEigen(double thresh,
      ...
      /**
       * Same as lsomPimHessianGenprocEigen(), but with PIM start tg vectors pre-computed and passed as function params
       * Useful for debugging against Matlab implementation
       */
      void lsomPimHessianGenprocEigenWithStartingPts(double thresh,
                                                     const SomUtils::VecMatD &R, const SomUtils::MatD &T, const SomUtils::MatD &Lambdas,
       ...
       * @param lambdaPimOut, vPimRout, vPimTout reference outputs: associated eigencouple
       */
      void lsomEscapeHessianGenprocEigen(const SomUtils::VecMatD &R, const SomUtils::MatD &T, const SomUtils::MatD &Lambdas,
       ...
       * on ROPTLIB's Armijo-Goldstein (armijo = true) implementation of simply linesearchDummy (armijo = false)
       */
      void lsomPimHessianGenproc(double thresh,
                                 const SomUtils::VecMatD &R, const SomUtils::MatD &T, const SomUtils::MatD &Lambdas,
                                 Vector &Y0,
                                 bool armijo = false) const;
       ...
       */
      void linesearchDummyLsom(const double costInit,
      ...
      void makeHmatLsom(const SomUtils::MatD &XvecNext, const SomUtils::SomSize &szNext, SomUtils::MatD &Hmat) const;
   ...
   /**
    * @brief Solve an instance of the LSOM problem using RS
    */
