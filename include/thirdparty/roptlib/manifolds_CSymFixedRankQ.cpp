...
namespace ROPTLIB
{
    ...
    realdp CSymFixedRankQ::Metric(const Variable &x, const Vector &etax, const Vector &xix) const
    {
        ...
        { /*2 \trace(x^H etax x^H xix + x^H x etax^H xix)*/
            ...
            Vector tmp1(p, p, "complexRopt");
            tmp1.AlphaABaddBetaThis(GLOBAL::ZONE, etax, GLOBAL::C, x, GLOBAL::N, GLOBAL::ZZERO);
            Vector tmp2(p, p, "complexRopt");
            tmp2.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, xix, GLOBAL::N, GLOBAL::ZZERO);
    ...
    {
        Vector XTX(p, p, "complexRopt");
        XTX.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, x, GLOBAL::N, GLOBAL::ZZERO);
        Vector XTV(p, p, "complexRopt");
        XTV.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, etax, GLOBAL::N, GLOBAL::ZZERO);
        XTV = XTX % XTV;
    ...
    Variable &CSymFixedRankQ::Retraction(const Variable &x, const Vector &etax, Variable *result) const
    {
        if (IsIntrApproach)
        {
            ...
            tmp1.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, x, GLOBAL::N, GLOBAL::ZZERO);
            Vector tmp2(p, p, "complexRopt");
            tmp2.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, exetax, GLOBAL::N, GLOBAL::ZZERO);
            Vector S = tmp1 % tmp2; /* S = (x.GetTranspose() * x) % (x.GetTranspose() * exetax); */
            Vector Yp(exetax);
            Yp.AlphaABaddBetaThis(GLOBAL::ZNONE, x, GLOBAL::N, S, GLOBAL::N, GLOBAL::ZONE); /* Yp = etax - x * S; */
            ...
            Vector XtY(p, p, "complexRopt");
            XtY.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, Yp, GLOBAL::N, GLOBAL::ZZERO); /* XtY = x.GetTranspose() * Yp; */
            XtY.SVDDecom();
    ...
    Vector &CSymFixedRankQ::EucGradToGradEUC(const Variable &x, const Vector &egf, const Problem *prob, Vector *result) const
    {
        ...
        *result = (egf / XTX) / 2; /* result = (egf / (x.GetTranspose() * x)) / 2 */
        Vector tmp1(p, p, "complexRopt");
        tmp1.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, *result, GLOBAL::N, GLOBAL::ZZERO); /*tmp1 = x.GetTranspose() * ((egf / XTX) / 2) */
        tmp1 = XTX % tmp1;
    ...
    Vector &CSymFixedRankQ::EucHvToHvEUC(const Variable &x, const Vector &etax, const Vector &exix, const Problem *prob, Vector *result) const
    {
        ...
        Vector xTEGYYinv(p, p, "complexRopt");
        xTEGYYinv.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, EGYYinv, GLOBAL::N, GLOBAL::ZZERO);
        Vector YYinvYTEGYYinv = XTX % xTEGYYinv;

        Vector EtaTEGYYinv(p, p, "complexRopt");
        EtaTEGYYinv.AlphaABaddBetaThis(GLOBAL::ZONE, etax, GLOBAL::C, EGYYinv, GLOBAL::N, GLOBAL::ZZERO);
        Vector YTeta(p, p, "complexRopt");
        YTeta.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, etax, GLOBAL::N, GLOBAL::ZZERO);
        Vector YTxix(p, p, "complexRopt");
        YTxix.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, exix, GLOBAL::N, GLOBAL::ZZERO);
    ...
    Vector &CSymFixedRankQ::EucHvToHvHGZ(const Variable &x, const Vector &etax, const Vector &exix, const Problem *prob, Vector *result) const
    {
        ...
        XTX.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, x, GLOBAL::N, GLOBAL::ZZERO);
        Vector EGYYinv = egf / XTX;
        Vector YTEGYYinv(p, p, "complexRopt");
        YTEGYYinv.AlphaABaddBetaThis(GLOBAL::ZONE, x, GLOBAL::C, EGYYinv, GLOBAL::N, GLOBAL::ZZERO);
        Vector EtaTEGYYinv(p, p, "complexRopt");
        EtaTEGYYinv.AlphaABaddBetaThis(GLOBAL::ZONE, etax, GLOBAL::C, EGYYinv, GLOBAL::N, GLOBAL::ZZERO);
        Vector EtaTY(p, p, "complexRopt");
        EtaTY.AlphaABaddBetaThis(GLOBAL::ZONE, etax, GLOBAL::C, x, GLOBAL::N, GLOBAL::ZZERO);
