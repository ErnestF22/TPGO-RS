...
complexRopt matrix and U_p is a p-by-p unitary group. This manifold is equivalent to the manifold of the set of hermitian positive
semidefinite matricies with rank fixed (rank p).
 ...
 Details can be found in [HGZ2015].
    [HGZ2015]:W. Huang, Kyle A. Gallivan, and Xiangxiong Zhang. Solving PhaseLift by low rank Riemannian optimization methods for complexRopt semidefinite constraints.
...
namespace ROPTLIB
{
    ...
    */
    enum CSFRankQVectorTransport
    {
        CSFRANKQPARALLELIZATION,
        CSFRANKQPROJECTION,
        CSFRANKQVECTORTRANSPORTLENGTH
    };
