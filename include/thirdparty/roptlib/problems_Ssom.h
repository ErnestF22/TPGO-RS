...
namespace ROPTLIB
{
   ...
   class SsomProblem : public Problem
   {
   public:
      /**
       ...
       */
      SsomProblem(SomUtils::SomSize somSz, SomUtils::MatD &Tijs, Eigen::MatrixXi &edges);

      /**
       * Standard constructor with problem data inputs (most commonly used)
       */
      SsomProblem(const SomUtils::SomSize somSz, const SomUtils::MatD &Tijs, const Eigen::MatrixXi &edges);
   ...
   /**
    * @brief Solve an instance of the SSOM problem using RS
    */
