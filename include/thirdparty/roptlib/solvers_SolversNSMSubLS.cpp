...
#include "solvers_SolversNSMSubLS.h"
...
namespace ROPTLIB
{
    ...
    void SolversNSMSubLS::SetParams(PARAMSMAP params)
    {
        ...
        for (iter = params.begin(); iter != params.end(); iter++)
        {
            ...
            else if (iter->first == static_cast<std::string>("Theta_eps"))
            {
                Theta_eps = static_cast<realdp>(iter->second);
            }
            else if (iter->first == static_cast<std::string>("Min_Eps"))
            {
                Min_Eps = static_cast<realdp>(iter->second);
            }
            else if (iter->first == static_cast<std::string>("Del"))
            {
                Del = static_cast<realdp>(iter->second);
            }
            else if (iter->first == static_cast<std::string>("Theta_del"))
            {
            ...
            else if (iter->first == static_cast<std::string>("lambdaLower"))
            {
