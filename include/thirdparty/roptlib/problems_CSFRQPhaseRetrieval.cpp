...
#include "problems_CSFRQPhaseRetrieval.h"
...
namespace ROPTLIB
{
    ...
    { /*x is a n1 * n2 by r complexRopt matrix*/
        Vector cD(m);
        cD.SetToZeros();
        Vector ZY(m, r, "complexRopt");
        realdp sqn = sqrt(static_cast<realdp>(n1 * n2));
        Vector tmpv(n, "complexRopt"), tmpv2(n, "complexRopt");
