...
// #include "problems_SphereTxRQ/SphereTxRQ.h"
#include "solvers_SolversSMLS.h"
#include <ctime>

#include "manifolds_Euclidean.h"
// #include "manifolds_Euclidean/EucVariable.h"

// #include "manifolds_Stiefel/StieVector.h"
// #include "manifolds_Stiefel/StieVariable.h"
// #include "manifolds_Stiefel/Stiefel.h"
...
Manifold *GetAManifold(const char *name, integer n, integer m, integer p)
{
	...
	else if (strcmp(name, "CStiefel") == 0)
	{
		return new CStiefel(n, p);
	}
	else if (strcmp(name, "CSymFixedRankQ") == 0)
	{
	...
	else if (strcmp(name, "FixedRankE") == 0)
	{
		return new FixedRankE(m, n, p);
	}
	else if (strcmp(name, "FixedRankQ2F") == 0)
	{
		return new FixedRankE(m, n, p);
	}
	else if (strcmp(name, "Grassmann") == 0)
	{
		return new Grassmann(n, p);
	}
	else if (strcmp(name, "SPDManifold") == 0)
	{
	...
	else if (strcmp(name, "Stiefel") == 0)
	{
		return new Stiefel(n, p);
	}
	else if (strcmp(name, "SymFixedRankQ") == 0)
	{
