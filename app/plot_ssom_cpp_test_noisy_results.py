...
for f in folders:
    ...
    len_timestamp = 17
    testid = folder[len(rsom_rs_results_path) + 1 : len(folder) - len_timestamp]
    ...
    tuple_rs = (n, mindeg, sigma, rot_errs_mean_rs, transl_errs_mean_rs, scale_errs_mean_rs, exec_times_mean_rs)
