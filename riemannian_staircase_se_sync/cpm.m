...
sesync_riemstair_rot_errs = zeros(size(sigmas));
sesync_riemstair_transl_errs = zeros(size(sigmas));
sesync_riemstair_exec_times = zeros(size(sigmas));
...
for ii = 1:size(sigmas,1)
    ...
    sesync_riemstair_rot_errs_per_sigma = zeros(num_edges, num_tests_per_sigma);
    sesync_riemstair_transl_errs_per_sigma = zeros(num_edges, num_tests_per_sigma);
    sesync_riemstair_exec_times_per_sigma = zeros(1, num_tests_per_sigma); %column-wise just to keep a similar notation to the error vectors
...
%         end
        ...
        [manopt_sep_rot_err, manopt_sep_transl_err, ...
            ...
            sesync_riemstair_rot_err, sesync_riemstair_transl_err, ...
            manopt_sep_exec_time, procrustes_exec_time, sesync_riemstair_exec_time] = ...
            do_som_procrustes_manopt_sesyncriemstair(testdata, sigma, mu, som_params); % do_som();
        ...
        sesync_riemstair_rot_errs_per_sigma(:, jj) = sesync_riemstair_rot_err;
        sesync_riemstair_transl_errs_per_sigma(:, jj) = sesync_riemstair_transl_err;
        sesync_riemstair_exec_times_per_sigma(:, jj) = sesync_riemstair_exec_time;
    end
    ...
    sesync_riemstair_rot_errs(ii) = mean(sesync_riemstair_rot_errs_per_sigma,"all");
    sesync_riemstair_transl_errs(ii) = mean(sesync_riemstair_transl_errs_per_sigma,"all");
    sesync_riemstair_exec_times(ii) = mean(sesync_riemstair_exec_times_per_sigma);
...
disp("sesync_riemstair_rot_errs");
disp(sesync_riemstair_rot_errs);

disp("sesync_riemstair_transl_errs");
disp(sesync_riemstair_transl_errs);
...
disp("sesync_riemstair_exec_times");
disp(sesync_riemstair_exec_times);
...
results = struct("manopt_sep_rot_errs", manopt_sep_rot_errs, ...
    ...
    "sesync_riemstair_rot_errs", sesync_riemstair_rot_errs, ...
    "sesync_riemstair_transl_errs", sesync_riemstair_transl_errs, ...
    "sesync_riemstair_exec_times", sesync_riemstair_exec_times);

%plot results
plot_results(sigmas, results, "procrustes_manopt_sesyncriemstair");
