function [T_out, T_cost, T_info, T_options] = ssom_manopt_step2( ...
    R_gf, Tijs, edges, params, T_initguess)
...
% checkgradient(problem_step2);
% checkhessian(problem_step2);
 
% Solve.
if params.initguess_is_available
    [T_out, T_cost, T_info, T_options] = trustregions(problem_step2, T_initguess);
else
