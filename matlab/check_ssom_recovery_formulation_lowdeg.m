...
[~, Tij1j2_tilde] = make_Tij1j2s_edges(node_id, Qx_edges * T_diffs, tijs,edges,problem_data);

Qalign=align3d(Tij1j2_tilde);
%Qalign=fliplr(orthCompleteBasis(null(Tij_tilde_pre')))';

Tij_tilde=multiprod(Qalign, Tij1j2_tilde);



RitildeEst = RbRecovery(R(:,:,node_id), Tij_tilde);
