...
%% Re-running using previous output as initguess for noiseless case
...
som_params = struct('N', N, 'd', d, 'd_aff', d_aff, ...
    ...
    'enable_ssom', enable_ssom, ...
    'perform_globalization', perform_globalization, ...
    'R_initguess', R_initguess, ...
    'T_initguess', T_initguess, ...
    'lambdas_initguess', lambdas_initguess);
