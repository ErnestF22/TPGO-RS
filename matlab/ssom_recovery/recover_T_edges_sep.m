function T_edges_shifted = recover_T_edges_sep(T_edges, edges, d, ...
    node_degrees, low_deg, Tij_tilde_2deg_recovery, Qalign, Qalign_neg)
    ...
    for ee = 1:size(edges, 1)
        ...
        if ismember(ii, low_deg_nodes_ids) 
            ...
            % T_edges_shifted(:,ee) = Qalign_neg * inv(Qalign) * P * T_edges(:,ee);
