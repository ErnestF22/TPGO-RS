...
for ii = 1:length(alphas)
    x_retr_ii = problem_manopt.M.retr(X_cat, v_cat, alphas(ii));
...
%     disp([matStack(x), matStack(x_retr_ii)])
    ...
    rhess = ssom_rhess_genproc(X_cat, v_cat, problem_data_next);
