function [Ri_est, Qx, Qb]=RbRecovery(Ri_tilde2,Tij_tilde,pmRbEst)
...
if nbPoses>1
    ...
    if  pmRbEst
        Rb_est=procrustes_R(Qbot_right',Rcal_bot_N); % +- Rcal_bot_N might be useful for 4-rows staircase
    else
