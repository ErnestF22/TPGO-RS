function [transf_out, rs_recovery_success, cost_out_global] = pic_rsom_genproc(T_gf, Tijs, edges, params, transf_initguess, testdata_plot)
...
X = pic_trustregions(problem, [], [], testdata_plot);
T_manopt_out = X.T;
R_manopt_out = X.R;
...
for staircase_step_idx = r0:d*N+1
    ...
    X = pic_trustregions(problem_next, Y_star, [], testdata_plot);
    T_manopt_out = X.T;
    R_manopt_out = X.R;
