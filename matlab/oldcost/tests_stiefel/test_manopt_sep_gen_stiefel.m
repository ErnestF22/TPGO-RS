function test_manopt_sep_gen_stiefel %converted to function due to very long test exec time
...
num_rows_stiefel = d;
transf_manopt_sep = som_manopt_stiefel(T_globalframe, Tijs_vec, edges, num_rows_stiefel, som_params, matStack(RT2G(R_initguess, transl_initguess)));

transf_manopt_gen = som_manopt_genproc_stiefel(T_globalframe, Tijs_vec, edges, num_rows_stiefel, som_params, matStack(transf_initguess));
