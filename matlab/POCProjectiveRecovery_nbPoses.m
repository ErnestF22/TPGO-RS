function POCProjectiveRecovery_nbPoses()
nbPoses=3;
Ti=randn(3,1,nbPoses);
Tj=randn(3,2,nbPoses);
Ri=rot_randn(eye(3),[],nbPoses);
Tij=Tj-Ti;
...
Tij=[Tij;zeros(dimStair-3,2,nbPoses)];
Ri=[Ri;zeros(dimStair-3,3,nbPoses)];
