function [rotation_error_manopt,translation_error_manopt, ...
    ...
    do_som_manopt_rgrad_twomodes_stiefel(testdata, sigma, mu, params)
%DO_SOM_RGRAD_TWOMODES_STIEFEL Function that executes the Shape of Motion 
%algorithms through Manopt pipelines, with formulation on Stiefel manifold,
%returning rotation and translation
...
params.riem_grad_mode = 'auto';
manopt_ad_start_time = tic();
transf_manopt_ad = som_manopt_stiefel(T_globalframe_nois, Tijs_vec_nois, edges, params, matStack(transf_initguess));
...
testdata.gi = matUnstack(transf_manopt_ad, 4);
