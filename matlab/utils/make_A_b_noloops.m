function [A_nl,b_nl,R] = make_A_b_noloops(R, T_globalframe_nois, Tijs_vec, edges, params)
...
Anl_4d = reshape(Anl_3d, d, d, num_edges, N);
Anl_4d_perm = permute(Anl_4d, [1,2,4,3]);
Anl_hor_stacked = matStackH_d2(Anl_4d_perm);
Anl_hor_stacked_cells = mat2cell(Anl_hor_stacked, d, (d*N).*ones(1, num_edges));
A_nl = cell2mat(Anl_hor_stacked_cells(:));

A_nl_copy = A_nl;
A_nl_copy_cells = mat2cell(A_nl_copy, d*ones(1, num_edges), d*ones(1, N));
