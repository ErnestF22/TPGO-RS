...
function [h] = ehess_genproc(X, Xdot, problem_data)
    R = X.R;
    T = X.T;
    Rdot = Xdot.R;
    Tdot = Xdot.T;
    ...
    h.R = rsom_ehess_rot_stiefel(R, Rdot, problem_structs) + hrt;
    h.T = rsom_ehess_transl_stiefel(T, Tdot, problem_structs) + htr;
end %ehess
