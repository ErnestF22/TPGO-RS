function [lambda_max, x_max] = lsom_pim_function_genproc(f, x_start, normalization_fun, thresh, num_max_iter)
...
% Note, this is the same as ssom_pim_function_genproc, but preferred
% renaming it to avoid confusion/further doubts
