function [transf_out, lambdas_out]  = ssom_procrustes_qp(T_init, lambdas_init, tijs, edges, params)
...
if (procrustes_mode == "som")
    ...
    %     end
    [transl_curr, lambdas_curr] = solve_ssom_T_lambdas_qp(rot_curr, params);
