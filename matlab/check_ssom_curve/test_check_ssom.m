...
L = readmatrix("../data/stiefel_noisy_cost_components/L_stiefel_noisy.csv");
P = readmatrix("../data/stiefel_noisy_cost_components/P_stiefel_noisy.csv");
A = readmatrix("../data/stiefel_noisy_cost_components/A_stiefel_noisy.csv");
B = readmatrix("../data/stiefel_noisy_cost_components/B_stiefel_noisy.csv");
fixed_cost_term = readmatrix("../data/stiefel_noisy_cost_components/fixed_cost_term.csv");
