function sfm_poseCombine_testOutliersOutband_run(dataset,experimentNumber)
...
for iExperimentNumber=1:NExperimentNumber
    ...
    [NTrials,NSigmas]=size(matchPoseAdded);
    ...
    for iTrial=1:NTrials
        ...
        for iSigma=1:NSigmas
            ...
            dataSigmas{iSigma}.matchPoseEstimated=cat(3,dataSigmas{iSigma}.matchPoseTruth,matchPoseAdded{iTrial,iSigma});
            dataSigmas{iSigma}.matchFiltered=[dataSigmas{iSigma}.matchFiltered matchFilteredAdded{iTrial,iSigma}];
