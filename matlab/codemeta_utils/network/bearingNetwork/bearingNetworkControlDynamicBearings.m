%Compute velocity part of double integrator control law from bearings
%function uBearings=bearingNetworkControlDynamicBearings(E,dy,varargin)
function uBearings=bearingNetworkControlDynamicBearings(E,dy,varargin)
threshold=Inf;
flagClamp=false;
flagRemove=false;
